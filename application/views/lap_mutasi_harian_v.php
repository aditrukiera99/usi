		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-green-haze">
					...
					<span class="caption-subject bold uppercase"> Form Search Laporan Posisi Saldo </span>
				</div>
				<div class="actions">
			...
			<div class="portlet-body form">
				<form role="form" target="_blank" class="form-horizontal" method="post" action="<?=base_url();?>lap_mutasi_harian_c/cetak/">
					<div class="form-body">
