...
<div class="row-fluid" style="background: #F5EADA; padding-top: 15px; padding-bottom: 15px;">
	...
	<div class="span4">
			...
			<label class="control-label"> <b style="font-size: 14px;"> Tanggal Transaksi </b> </label>
				<div class="controls">
					<div class="input-append date ">
						<input readonly style="width: 80%;" value="<?=date('d-m-Y');?>" required name="tgl_trx" onclick="$('#add_on_pick').click();" data-format="dd-MM-yyyy" type="text"><span class="add-on "><i class="icon-calendar"></i></span>
					</div>
				</div>
		</div>
		...
		<div class="control-group" style="margin-left: 10px;">
			...
			<div class="controls">
				<input required type="text" class="span12" value="<?=$bukti_kas;?>-" name="no_trx" id="no_trx" style="background: #FFF; font-size: 16px;">
		...
		<div class="content-widgets light-gray" style="background: #F5EADA;">
			...
			<div class="widget-container">
				<div class="control-group" style="margin-left: 20px; display: none;">
					...
					<div class="controls">
						<input style="font-size: 14px;" required  type="text" class="span6" value="" name="nilai_transaksi" id="nilai_transaksi" onkeyup="FormatCurrency(this); hitung_total_semua();">
					</div>
				</div>
			</div>
		</div>
					...
					<tbody id="tes">
						<tr id="tr_1" class="tr_utama">
									...
									<div class="control-group">
										<div class="controls">
											<div class="input-append" style="width: 100%;">
												<input readonly type="text" id="nama_produk_1" name="nama_produk[]" required style="background:#FFF; width: 60%; font-size: 10px;">
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="span12">
								<div class="controls">
									<input onkeyup="FormatCurrency(this); always_one(1); hitung_total(1);" required onchange="" id="qty_1" style="font-size: 18px; text-align:center; width: 80%;" type="text"  value="" name="qty[]">
								</div>
								</div>
							</td>
		...
		<div class="content-widgets light-gray">
			...
			<div class="widget-container">
				...
				<div class="form-actions">
					...
					<input type="submit" value="Simpan Transaksi" name="simpan" class="btn btn-info">
