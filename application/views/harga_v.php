...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-money"></i> Master Harga  </h3>
			<a class="btn btn-info view_data" href="<?=base_url();?>harga_c/add_new" style="float: right;"> 
				<i class="icon-plus" style="color: #FFF; font-size: 16px; left: 0; position: relative; top: 2px;"></i> INPUT HARGA BARU
			</a>
		</div>
		<ul class="breadcrumb">
