				...
				<form class="form-horizontal" method="post" action="<?=base_url().$post_url;?>">
					...
					<div class="control-group">
						...
						<div class="controls">
								...
								<input type="text" name="nama_pel" style="font-size: 14px;" class="span6" value="<?=$dt->NAMPEL;?>">
					...
					<div class="control-group">
						...
						<div class="controls">
								...
								<input type="text" name="nama_produk" style="font-size: 14px;" class="span6" value="<?=$dt->NAMPROD;?>">
