			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-append">
						...
						<input type="hidden" id="kota_tujuan" value="<?=$dt->ID_PELANGGAN;?>" name="kota_tujuan" readonly style="background:#FFF;">
		...
		<div class="content-widgets light-gray">
			...
			<div class="widget-container">
				...
				<div class="form-actions">
					...
					<button class="btn" onclick="window.location='<?=base_url();?>delivery_order_beli_c' " type="button"> Batal dan Kembali </button>
					</center>
				</div>
			</div>
		</div>
