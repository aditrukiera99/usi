		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-green-haze">
					...
					<span class="caption-subject bold uppercase"> Form Ubah Data Bukti Kas Keluar </span>
				</div>
				<div class="actions">
			...
			<div class="portlet-body form">
				<form role="form" class="form-horizontal" method="post" action="<?php echo $url_simpan; ?>">
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								<select  class="form-control input-large select2me input-sm" id="id_supplier" name="id_supplier" data-placeholder="Select..." required>
									...
									?>
										<option <?PHP if($value->id_supplier == $dt->ID_SUPPLIER){ echo "selected"; } ?> value="<?php echo $value->id_supplier; ?>"><?php echo $value->kode_supplier; ?> - <?php echo $value->nama_supplier; ?></option>
									<?php	
										}
									?>
								</select>	
						...
						<div class="form-group">
							<label class="col-md-2 control-label" for="form_control_1" >Pembayaran Untuk</label>
							<div class="col-md-5">
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-2 col-md-10">
								<a href="<?=base_url();?>pemasukan_kas_c" id="batal" class="btn red">Batal Dan Kembali</a>
