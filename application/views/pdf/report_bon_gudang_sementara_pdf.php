...
<table style="width: 100%">
	...
	<tr>
		...
		<td style="width: 15%;text-align: right;border: 1px solid black;"><?=$dt->id_bon_gudang;?></td>
	</tr>
</table>
...
<table style="width: 100%;height: 300px;">
		...
		<tr>
			...
			<th style="width: 35%;padding: 5px 5px 5px 5px; border-top: 1px solid black; border-bottom: 1px solid black;border-right: none;border-left: none;">No Reff</th>
		</tr>
		<?php 
		$i = 0;
...
<table style="width: 100%;">
	<tr>
		...
		<td style="width: 30%;">Menyetujui Gudang</td>
		<td style="width: 30%;text-align: center;">Yang Menyerahkan</td>
		<td style="width: 30%;text-align: center;">Yang Meminta</td>
	</tr>
</table>
<br>
<br>
...
<?PHP
    ...
    $html2pdf->pdf->SetTitle('Surat Pengembalian Barang');
    $html2pdf->WriteHTML($content, isset($_GET['vuehtml']));
    $html2pdf->Output('Surat_Pengembalian_barang.pdf');
?>