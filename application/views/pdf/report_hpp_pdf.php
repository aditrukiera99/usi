...
<table align="center">
    <tr>
        <td align="center">
            <h4>
                LAPORAN HARGA POKOK PENJUALAN <br>
                <?=strtoupper($judul);?>   
            </h4>
        </td>
    </tr>
...
<table align="center" class="grid">
    <tr>
        <th style='text-align:center; width:10%;' class='kolom_header'> NO </th>
        <th style='text-align:center; width:10%;' class='kolom_header'> ITEM </th>
        <th style='text-align:center; width:20%;' class='kolom_header'> SATUAN </th>
        <th style='text-align:center; width:10%;' class='kolom_header'> HPP (Rp) </th>
    </tr>
    <?PHP 
    $no = 0;
    ...
    <tr>
        <th style='text-align:center;' class='kolom_header' colspan="6">TOTAL PENJUALAN </th>
...
<?PHP
    ...
    $html2pdf->pdf->SetTitle('Laporan HPP');
    $html2pdf->WriteHTML($content, isset($_GET['vuehtml']));
    $html2pdf->Output('Laporan_hpp.pdf');
?>