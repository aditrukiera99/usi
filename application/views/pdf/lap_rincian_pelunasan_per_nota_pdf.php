  ...
  <table style="border-collapse: collapse; width: 100%; text-align:center; font-size: 80%;font-family: Arial;">
      <tbody>
       ...
       <tr style="font-weight: bold">
          ...
          <td rowspan="2" style="border: 1px solid black;">TANGGAL<br>J.TEMPO</td>
          <td rowspan="2" style="border: 1px solid black;">GUDANG</td>
          <td rowspan="2" style="border: 1px solid black;">DISKON</td>
...
<!-- ------------ISI--------------- -->
    ...
    <tr>
      <td  style="border: 0px solid black;">&nbsp</td>
    ...
    <tr style="font-weight: bold">
      ...
      <td  style="border: 1px solid black;"></td>
      <td  style="border: 1px solid black;">xxx</td>
      <td bgcolor="yellow" style="border: 0px solid black;">SISA</td>
      <td bgcolor="yellow" style="border: 0px solid black;">xxx</td>
    </tr>
