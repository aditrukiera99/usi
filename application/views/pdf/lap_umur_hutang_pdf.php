    ...
    <table style="border-collapse: collapse; width: 100%; font-size: 80%;">
      <thead>
        ...
        <tr style="text-align:center; background-color: #BBDFEB;">
          ...
          <td colspan="5" style="border: 1px solid black;">OVER DUE</td>
        </tr>
        <tr style="text-align: center; background-color: #BBDFEB;">
          <td style="border: 1px solid black;">01-30</td>
          <td style="border: 1px solid black;">31-60</td>
          <td style="border: 1px solid black;">61-90</td>
      ...
      <tbody>
        ...
        <tr>
          <td style="border: 1px solid black;"></td>
          <td colspan="5" style="border: 1px solid black; font-weight: size; text-align: right;">GRAND TOTAL</td>
          <td style="border: 1px solid black;"></td>
          <td style="border: 1px solid black;"></td>
          <td style="border: 1px solid black;"></td>
          <td style="border: 1px solid black;"></td>
