...
<div style="width: 100%;padding-top: 10px;padding-bottom: 10px;padding-left:5px;">
	<table style="width: 100%;">
		<tr>
			<td style="width: 10%;text-align:left;font-size: 15px;"><b>No. BKK</b></td>
			<td style="width: 40%;text-align:left;font-size: 15px;">: <?=$dt->NO_VOUCHER;?></td>
			<td style="width: 13%;text-align:left;font-size: 15px;"><b>Tanggal</b></td>
			<td style="width: 20%;text-align:left;font-size: 15px;">: <?PHP echo date("d F Y", strtotime($dt->TGL)); ?> </td>
		</tr>
		<tr>
			<td style="width: 10%;text-align:left;font-size: 15px;"><b>Bank</b></td>
			<td style="width: 40%;text-align:left;font-size: 15px;">: <?=$dt->NAMA_AKUN;?></td>
			<td  style="width:13%;text-align:left;font-size: 15px;"><b>Dibayar Kpd</b></td>
			<td  style="width:20%;text-align:left;font-size: 15px;"> : <?=$dt->KONTAK;?></td>
		</tr>
	</table>
</div>
<br>
...
<table style="border-collapse: collapse;border:1px solid black;">
		...
		<tr>
			...
			?>
				<tr>
					...
					<td style="padding: 5px;border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black; text-align: right;">Rp.<?=number_format($va->DEBET, 2);?></td>
				</tr>
			<?php
			}
			?>
		...
		<tr>
			...
			<td style="border:1px solid black; border-left: none; padding: 5px; text-align: right;">Rp <?=number_format($dt->KREDIT, 2);?></td>
		</tr>
		<tr>
			<td colspan="3"><b>Terbilang : </b> <?PHP echo terbilang($dt->KREDIT, $style=4); ?> Rupiah</td>
		</tr>
</table>
