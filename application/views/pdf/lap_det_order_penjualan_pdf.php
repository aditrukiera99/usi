  ...
  <table style="border-collapse: collapse; width: 100%; text-align:center; font-size: 80%;">
      <tbody>
        ...
        <tr>
          ...
          <td rowspan="2" style="border: 1px solid black;">TOTAL <br>DISKON</td>
          <td rowspan="2" style="border: 1px solid black;">TOTAL <br>BERSIH</td>
        ...
        <tr>
          ...
          <td style="border: 1px solid black;">HIGH SOEED DIES</td>
          <td style="border: 1px solid black;"></td>
          <td style="border: 1px solid black;"></td>
          <td style="border: 1px solid black;"></td>
          <td style="border: 1px solid black;"></td>
        ...
        <tr>
          <td style="border: 0px solid black;"></td>
          <td style="border: 1px solid black;">PBBKB</td>
          <td style="border: 1px solid black;"></td>
          <td style="border: 1px solid black;"></td>
          <td style="border: 1px solid black;"></td>
          <td style="border: 1px solid black;"></td>
...
<!-- <table style="border-collapse: collapse; width: 100%; text-align:center; font-size: 80%;">
      <tbody> -->
        <tr>
          <td colspan="14" style="border: 0px solid black;"> <br> </td>
        </tr>
        <tr>
          <td colspan="11" style="border: 1px solid black;">GRAND TOTAL</td>
