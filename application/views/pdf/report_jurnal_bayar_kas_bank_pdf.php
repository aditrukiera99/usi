...
<table align="center" style="width:100%;">
    <tr>
        <td align="center">
            ...
            <h2 style="margin-top:-10px;"> <?=$dt_unit->NAMA_UNIT;?> </h2>
        </td>
    </tr>
</table>
...
<table align="center" class="grid" style="width:100%;">
    <?php
        ...
        echo "<tr>" ;
            ...
            echo "<th style='text-align:center;' class='kolom_header' rowspan='2'> SISA </th>" ;
        echo "</tr>" ;
        ...
        foreach ($data as $key => $row) {
            ...
            if (strpos($row->KODE_AKUN , '200') !== false) {
                $utang_usaha = $row->DEBET;
            }

            if (strpos($row->KODE_AKUN , '260') !== false) {
                $utang_non_usaha = $row->DEBET;
            }

            if (strpos($row->KODE_AKUN , '240') !== false) {
                $ppn = $row->DEBET;
            }
            ...
            echo "<tr>" ;
                ...
                echo "<td class='gridtd' align='right'> ".format_akuntansi($row->SISA_HUTANG - $row->DEBET)." </td>" ;
        ...
        echo "<tr>" ;
                echo "<td class='gridtd' align='center' colspan='6'> <b> JUMLAH PINDAHAN </b> </td>" ;
                ...
                echo "<td class='gridtd' align='right'> <b></b> </td>" ;
