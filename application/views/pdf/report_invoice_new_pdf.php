    ...
    <tr>
      ...
      foreach ($dt_deti as $key => $va) {
        ...
        <tr>
          ...
          <td style="padding: 5px;border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;text-align: center;vertical-align: top;">Rp. <?php echo number_format($va->TOTAL,2);?></td>
        </tr>
        <?php
      }
      ?>
