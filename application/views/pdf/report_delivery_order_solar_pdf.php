...
<tbody>
	...
	<tr>
		...
		<td style="vertical-align: top; width: 583px;"><?=$dt->PELANGGAN;?>		</td>
	</tr>
	<tr>
		<td style="vertical-align: top; width: 98px;"><br>
		</td>
		...
		<td style="vertical-align: top; width: 583px;"><?=$dt->ALAMAT_TUJUAN;?><br>
		<?=$dt->KOTA;?>		</td>
	</tr>
</tbody>
</table>
...
<td style="vertical-align: top; width: 319px;"><?=$dt->NO_BUKTI;?></td>
...
<?PHP 
$sql = "SELECT SUM(QTY) AS QTY FROM ak_pembelian_new_detail WHERE ID_PENJUALAN = '$dt->ID' ";
...
<table style="border-collapse: collapse; width: 100%; text-align: left; margin-left: auto; margin-right: auto;" border="3" cellpadding="0" cellspacing="0">
	...
	<col style="width: 83pt;" width="111"> 
		...
		<tr style="height: 15pt;" height="20">
			<td class="xl66" style="border-top: medium none; height: 15pt; text-align: center; width: 137px;" height="20"><br><?=$dt_det->NAMA_PRODUK;?><br><br></td>
