...
<?PHP 
$jml_kolom = $this->master_model_m->get_jml_kolom_laporan('JP');
$jml_kolom2 = $this->master_model_m->get_jml_kolom_laporan('JP') + 1;
?>
    ...
    <?php
        ...
        foreach ($data as $key => $row) {
            ...
            if ($old_koper != $koper) {
                ...
                echo "<tr>" ;
                echo "<td style='vertical-align:middle; height:15px; background:#FFF; border-bottom:1px solid black; border-left:none; border-right:none;' class='isi_no_border' colspan='".$jml_kolom2."'> NO BUKTI : <b style='color:#2980B9;'>".$row->NO_BUKTI."</b> <b> | ".$row->TGL."</b> </td>" ;
                echo "</tr>" ;

                echo "<tr>" ;
                echo "<td style='vertical-align:middle; height:15px; background:#FFF; border-bottom:1px solid black; border-left:none; border-right:none;' class='isi_no_border' colspan='".$jml_kolom2."'> URAIAN : <b> ".$row->URAIAN." (Disesuaikan dari ".$row->NO_VOUCHER.") </b> </td>" ;
                echo "</tr>" ;
