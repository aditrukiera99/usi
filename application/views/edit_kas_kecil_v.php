...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-plus"></i>  Ubah Kas Kecil </h3>
		</div>
		<ul class="breadcrumb">
			...
			<li class="active"> Ubah Kas Kecil Baru </li>
		</ul>
	</div>
</div>
...
<div class="row-fluid" style="background: #F5EADA; padding-top: 15px; padding-bottom: 15px;">
	<div class="span6">
		<div class="control-group" style="margin-left: 10px;">
			...
			<div class="controls">
				<input type="text" class="span8" value="<?=$dt->NO_BUKTI;?>" name="no_trx" id="no_trx" readonly style="font-size: 15px;">
			</div>
		</div>
		...
		<div class="control-group" style="margin-left: 10px;">
			...
			<div class="controls">
				<input type="text" class="span8" value="<?=$dt->DIBUAT_OLEH;?>"  name="oleh" id="oleh">
			</div>
		</div>
		...
		<div class="control-group" style="margin-left: 10px;">
			...
			<div class="controls">
				<textarea rows="4" id="untuk" name="untuk" style="resize:none; height: 87px; width: 80%;"><?=$dt->UNTUK;?></textarea>
			</div>
		</div>		
	</div>
	...
	<div class="span6">
		<div class="control-group" style="margin-left: 10px;">
			...
			<div class="controls">
				<textarea rows="4" id="memo" name="memo" style="resize:none; height: 87px; width: 80%;"><?=$dt->KETERANGAN;?></textarea>
			</div>
		</div> 
		...
		<div class="control-group" style="margin-left: 10px;">
			...
			<div class="controls">
				<input type="text" style="text-align: right;" class="span8" value="<?=number_format($dt->NILAI);?>" onkeyup="FormatCurrency(this);" name="nilai" id="nilai">
			</div>
		</div>
	</div>
</div>
...
<div class="form-actions">
	...
	<input type="submit" value="Ubah Kas Kecil" name="edit" class="btn btn-success">
	</center>
</div>
