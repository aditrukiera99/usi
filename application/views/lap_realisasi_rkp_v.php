<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-book"></i> Realisasi Pelaksanaan RKP</h3>
		...
		<ul class="breadcrumb">
			...
			<li class="active"> Realisasi Pelaksanaan RKP </li>
		</ul>
	</div>
</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<div class="input-append" style="width: 50%;">
								<input style="background: #FFF; font-size: 12px; width: 100%;" type="text" id="unit_txt" name="unit_txt" value="<?=$user->NAMA_UNIT;?>" readonly>
