...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-bookmark"></i>  PEGAWAI </h3>
...
<div class="row-fluid" id="view_data">
	<div class="span12">
		<button type="button" class="btn btn-block btn-info" onclick="tambah_klik();"> 
			<i class="icon-plus" style="color: #FFF; font-size: 16px;"></i> TAMBAH PEGAWAI
		</button>
		<br>
	...
	<div class="span12">
		<div class="content-widgets light-gray">
			<div class="widget-head blue">
				<h3> <i class="icon-plus"></i> Tambah Pegawai </h3>
			</div>
			<div class="widget-container">
				<form class="form-horizontal" method="post" action="<?=base_url().$post_url;?>">
					<div class="control-group">
						...
						<div class="controls">
							<input required type="text" class="span6" value="" name="nik" style="font-size: 14px;">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input required type="text" class="span6" value="" name="alamat" style="font-size: 14px;">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input required type="text" class="span6" value="" name="jabatan" style="font-size: 14px;">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input required type="text" class="span6" value="" name="departemen" style="font-size: 14px;">
						</div>
					</div>

					<div class="form-actions">
						
						<input type="submit" class="btn btn-info" name="simpan" value="SIMPAN PEGAWAI">
