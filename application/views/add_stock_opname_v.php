...
<div class="row-fluid">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-plus"></i> Input Stock Opname </h3>
		</div>
		<ul class="breadcrumb">
...
<div class="span12" style="background: #F5EADA">
		...
		<div class="row-fluid" style="background: #F5EADA; padding-top: 15px;">
			<div class="span6">
				<div class="control-group" style="margin-left: 10px;">
					...
					<div class="controls">
						<input required type="text" class="span12" value="<?=$bukti_kas;?>" name="no_stock_opname" id="no_stock_opname" style="font-size: 15px;">
	...
	<div class="span6">
		<div class="row-fluid" style="background: #F5EADA; padding-top: 15px;">
			<div class="span12">
				<div class="control-group" style="margin-left: 10px;">
					<label class="control-label"> <b style="font-size: 14px;" id="satuan_txt"> Kode Akun Opname (Kredit) </b> </label>
					<div class="controls">
		...
		<div class="row-fluid" style="background: #F5EADA;">
			<div class="span12">
				<div class="control-group" style="margin-left: 10px;">
					...
					<div class="controls">
						<textarea rows="4" id="catatan" name="catatan" style="resize:none; height: 87px; width: 90%;"></textarea>
					</div>
				</div>
			</div>	
		</div>
		...
		<div class="content-widgets light-gray">
			...
			<div class="widget-container">
				...
				<table class="stat-table table table-hover">
					<thead>
						<tr>
							<th align="center" style="vertical-align: middle; width: 20%;"> Kode Akun (Debet) </th>
					...
					<tbody id="tes">	
						<tr id="tr_1" class="tr_utama">
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="span12">
								<div class="controls">
									<input readonly id="qty_1" style="font-size: 18px; text-align:center; width: 50%;" type="text"  value="" name="qty[]">
								</div>
								</div>
							</td>
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="span12">
								<div class="controls">
									<input readonly type="text"  value="" name="harga_satuan[]" id="harga_satuan_1" style="font-size: 18px; text-align:right; width: 80%;">
								</div>
								</div>
							</td>
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="span12">
								<div class="controls">
									<input required onkeyup="FormatCurrency(this); hitung(1);" id="qty_fisik_1" style="font-size: 18px; text-align:center; width: 50%;" type="text"  value="" name="qty_fisik[]">
								</div>
								</div>
							</td>
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="span12">
								<div class="controls">
									<input required onkeyup="FormatCurrency(this); hitung(1);" id="harga_fisik_1" type="text" value="" name="harga_satuan_fisik[]" style="font-size: 18px; text-align:right; width: 80%;">
								</div>
								</div>
							</td>						
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="span12">
								<div class="controls">
									<input readonly id="qty_selisih_1" style="font-size: 18px; text-align:center; width: 50%;" type="text"  value="" name="qty_selisih[]">
								</div>
								</div>
							</td>
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="span12">
								<div class="controls">
									<input readonly id="harga_selisih_1" type="text" value="" name="harga_satuan_selisih[]" style="font-size: 18px; text-align:right; width: 80%;">
								</div>
								</div>
							</td>						
...
<div class="form-actions">
	<center>
	<input type="submit" value="SIMPAN OPNAME" name="simpan" class="btn btn-info">
