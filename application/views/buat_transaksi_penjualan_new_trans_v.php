		...
		<div class="span3">
			<div class="control-group">
				...
				<div class="controls">
					...
					<a href="<?=base_url();?>transaksi_penjualan_c/new_invoice"><button type="button" name="dengan_oat" class="btn btn-success" style="float: right;margin-right: 10px;margin-bottom: 20px;">SO TRANSPORTASI</button></a>
					<a href="<?=base_url();?>transaksi_penjualan_c/new_invoice"><button type="button" name="dengan_oat" class="btn btn-default" style="float: right;margin-right: 10px;margin-bottom: 20px;">SO BAHAN BAKAR</button></a>
				</div>
			</div>
		</div>
	</div>
...
function hitung_total(id){
	...
	// var harga_tanpa = ((parseFloat(harga_modal) * parseFloat(qty)) / (1 + parseFloat(pajak_ppn / 100))) ;
	var besar_ppn = parseFloat(pajak_ppn / 100) * profit;
	// var besar_pbbkb = parseFloat(pajak_pbbkb / 100) * profit;
	// var besar_oat = qty * semua_oat;

	var total_semua_harga = parseFloat(profit + besar_ppn) ;
