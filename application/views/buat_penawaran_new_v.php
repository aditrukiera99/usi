					...
					<tbody id="tes">
						<tr id="tr_1" class="tr_utama">
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="controls">
									<input onkeyup="FormatCurrency(this); always_one(1); hitung_total(1);" onchange="" id="qty_1" style="font-size: 18px; text-align:right; width: 80%;" type="text"  value="" name="qty[]">
