...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-eye-open"></i>  Detail Penawaran </h3>
		</div>
		<ul class="breadcrumb">
		...
		<div class="content-widgets light-gray">
			...
			<div class="widget-container">
				...
				<div class="form-actions">
					...
					<button class="btn" onclick="window.location='<?=base_url();?>penawaran_barang_c' " type="button">  Kembali </button>
					</center>
				</div>
			</div>
		</div>
