<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-book"></i> Laporan Kompilasi Neraca</h3>
		...
		<ul class="breadcrumb">
			...
			<li class="active"> Laporan Kompilasi Neraca </li>
		</ul>
	</div>
</div>
			...
			<div class="widget-container">
				<form action="<?=base_url().$post_url;?>" method="post" class="form-horizontal" target="_blank">
					...
					<div class="form-actions">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
						<input type="submit" value="Cetak Laporan Kompilasi Neraca" name="excel" class="btn btn-info">
					</div>
				</form>
			</div>
		</div>
