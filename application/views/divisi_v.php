...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-bookmark"></i>  Divisi </h3>
			<button type="button" class="btn btn-info view_data" onclick="tambah_klik();" style="float: right;"> 
				<i class="icon-plus" style="color: #FFF; font-size: 16px; left: 0; position: relative; top: 2px;"></i> TAMBAH DIVISI
			</button>
		</div>
		<ul class="breadcrumb">
	...
	<div class="span12">
		<div class="content-widgets light-gray">
			<div class="widget-head blue">
				<h3> <i class="icon-plus"></i> Tambah Divisi </h3>
			</div>
			<div class="widget-container">
				<form class="form-horizontal" method="post" action="<?=base_url().$post_url;?>">
					<div class="control-group">
						...
						<div class="controls">
							<input required type="text" class="span6" value="" name="nama_divisi" style="font-size: 14px;">
						</div>
					</div>

					<div class="form-actions">
						
						<input type="submit" class="btn btn-info" name="simpan" value="SIMPAN DIVISI">
...
<div class="row-fluid" id="edit_data" style="display:none;">
	<div class="span12">
		<div class="content-widgets light-gray">
			<div class="widget-head blue">
				<h3> <i class="icon-edit"></i> Ubah Divisi </h3>
			</div>
			<div class="widget-container">
				<form class="form-horizontal" method="post" action="<?=base_url().$post_url;?>">
					<div class="control-group">
						<label class="control-label"> NAMA DIVISI </label>
						<div class="controls">
							<input required type="text" class="span6" value="" id="nama_divisi_ed" name="nama_divisi_ed" style="font-size: 14px;">
					...
					<div class="form-actions">
						...
						<input type="submit" class="btn btn-info" name="edit" value="UBAH DIVISI">
...
function ubah_data_produk(id){
	$('#popup_load').show();
	$.ajax({
		url : '<?php echo base_url(); ?>divisi_c/cari_kendaraan_by_id',
		data : {id:id},
		type : "GET",
		dataType : "json",
		success : function(result){
			$('#popup_load').hide();
			$('#id_gr').val(result.ID);
			$('#nama_divisi_ed').val(result.NAMA_UNIT);
