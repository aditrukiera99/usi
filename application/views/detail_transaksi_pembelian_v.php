...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-pencil"></i>  Detail Transaksi Pembelian </h3>
		...
		<ul class="breadcrumb">
			...
			<li> Transaksi Pembelian <span class="divider"><i class="icon-angle-right"></i></span></li>
					...
					<tbody id="tes">
						...
						<tr id="tr_<?=$det->ID;?>" class="tr_utama">
							<td style="vertical-align:middle;"> 
								...
								<div class="control-group">
									<label class="control-label"> <?=$det->KODE_AKUN;?> <br> <?=$det->NAMA_AKUN;?> </label>
								</div>
							...
							<td style="vertical-align:middle;"> 
								...
								<div class="control-group">
									<label class="control-label"> <?=$det->NAMA_PRODUK;?>  </label>
								</div>
							...
							<td align="center" style="vertical-align:middle;">
								<div class="control-group">
									<label class="control-label"> <?=$det->QTY;?>  </label>
								</div>
							</td>

							<td align="center" style="vertical-align:middle;"> 
								<div class="control-group">
									<label class="control-label"> <?=$det->SATUAN;?>  </label>
								</div>
							</td>

							<td align="center" style="vertical-align:middle;"> 
								<div class="control-group">
									<label class="control-label"> <?=number_format($det->HARGA_SATUAN);?>  </label>
								</div>
							</td>

							<td align="center" style="vertical-align:middle;"> 
								<div class="control-group">
									<label class="control-label"> <?=number_format($det->TOTAL);?>  </label>
								</div>
							</td>
