...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-plus"></i>  Ubah Bukti Kas Masuk </h3>
		</div>
		<ul class="breadcrumb">
			...
			<li class="active"> Ubah Bukti Kas Masuk Baru </li>
		</ul>
	</div>
</div>
		...
		<div class="control-group" style="margin-left: 10px;">
			...
			<div class="controls">
				<div class="input-append">
					...
					<input type="hidden" id="id_pelanggan" name="id_pelanggan" style="background:#FFF; width: 70%;" value="<?=$dt->ID_KONTAK;?>" readonly>
				</div>
			</div>
		</div>		
	</div>
					...
					<tbody id="tes">
						...
						<tr id="tr_<?=$no;?>" class="tr_utama">
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="controls">
									<input onkeyup="FormatCurrency(this);" style="font-size: 14px; text-align:right; width: 80%;" type="text"  value="<?=number_format($row->KREDIT);?>" name="nilai[]" id="nilai_<?=$no;?>">
								</div>
							</td>
