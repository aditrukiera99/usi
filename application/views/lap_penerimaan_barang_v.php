...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-caret-right"></i> Penerimaan Barang (LPB) </h3>
		</div>
		<ul class="breadcrumb">
			<li><a href="#" class="icon-home"></a><span class="divider "><i class="icon-angle-right"></i></span></li>
			<li><a href="#">Pembelian / Penerimaan </a><span class="divider"><i class="icon-angle-right"></i></span></li>
			<li class="active"> Penerimaan Barang (LPB) </li>
		</ul>
	</div>
</div>
...
<div class="row-fluid ">
	<div class="span6">
		<form method="post" action="<?=base_url();?>lap_penerimaan_barang_c">
		<div class="control-group">
			<label class="control-label" style="font-weight: bold; font-size: 13px;">Tampilkan berdasarkan tanggal :</label>
			<div class="controls">
				<div class="input-prepend">
					<span class="add-on"><i class="icon-calendar"></i></span>
					<input type="text" required name="tgl" id="reservation" value="<?=$tgl_full;?>"/>
	...
	<div class="span6">
		<button onclick="window.location='<?=base_url();?>lap_penerimaan_barang_c/add_new';" style="float: right; margin-top: 12px;" type="button" class="btn btn-inverse opt_btn"> <i class="icon-plus"></i> Buat Penerimaan Barang </button>
	</div>
</div>
				...
				<table class="stat-table table table-hover" id="data-table">
					<thead>
						<tr>
							...
							<th align="center"> Diterima Dari </th>
					...
					<tbody id="tes">
						<?PHP  foreach ($dt as $key => $row) { ?>
							...
							<tr>
								...
								<td style="font-size:14px; text-align:left; vertical-align:middle;"> <?=$row->MEMO;?> </td>
								<td align="center" style="font-size:14px; text-align:center; vertical-align:middle;"> 								
									<div class="btn-group">
										...
										<ul class="dropdown-menu" style="background-color:rgba(255, 255, 255, 1); min-width: 120px;">
											...
											<?PHP } ?>
											<li>
											<a href="<?=base_url();?>transaksi_pembelian_c/detail/<?=$row->ID;?>">Detail</a>
											</li> -->
											<li>
											<a target="blank" href="<?=base_url();?>lap_penerimaan_barang_c/cetak/<?=$row->ID;?>">Cetak</a>
											</li>
										</ul>
									</div>
								</td>
