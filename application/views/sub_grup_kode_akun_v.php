...
<div class="row-fluid ">
    <div class="span12">
        <div class="primary-head">
            <h3 class="page-header"> <i class="icon-bookmark"></i> Sub Grup Kode Akun </h3>
...
<div class="alert alert-success">
    ...
    <i class="icon-ok-sign"></i><strong>Sukses!</strong> Pengubahan Sub Grup Akun telah diajukan. Mohon tunggu persetujuan atasan.
</div>
<?PHP } ?>
...
<div class="alert alert-success">
    <button type="button" class="close" data-dismiss="alert">×</button>
    <i class="icon-ok-sign"></i><strong>Sukses!</strong> Penghapusan Sub Grup Akun telah diajukan. Mohon tunggu persetujuan atasan.
</div>
<?PHP } ?>
...
<div class="alert alert-success">
    <button type="button" class="close" data-dismiss="alert">×</button>
    <i class="icon-ok-sign"></i><strong>Sukses!</strong> Sub Grup Akun telah diajukan. Mohon tunggu persetujuan atasan.
</div>
<?PHP } ?>
...
<div class="row-fluid" id="view_data">
    <div class="span12">
        <button type="button" class="btn btn-block btn-info" onclick="tambah_klik();"> 
            <i class="icon-plus" style="color: #FFF; font-size: 16px;"></i> TAMBAH SUB GRUP AKUN
        </button>
        <br>
                ...
                <table class="responsive table table-striped table-bordered" id="data-table">
                    <thead>
                        <tr>
                            ...
                            <th align="center"> KODE SUB GRUP </th>
                    ...
                    <tbody id="tes">
                        ...
                        <tr>
                            ...
                            <td> <?=$row->KODE_GRUP;?>.<?=$row->KODE_SUB;?>  </td>
                            <td> <?=$row->KODE_GRUP;?> </td>
                            <td align="left" > <?=$row->KODE_SUB;?> </td>
                            <td> <?=$row->NAMA_SUB;?> </td>
                            ...
                            <?PHP } else { ?>
                                <?PHP if($user->LEVEL == "MANAGER"){ ?>
                                    <?PHP $appr = $this->master_model_m->get_data_persetujuan('kode_sub', $row->ID); ?>
                                    <div class="btn-group">
    ...
    <div class="span12">
        <div class="content-widgets light-gray">
            <div class="widget-head blue">
                <h3> <i class="icon-plus"></i> Tambah Sub Grup Akun unit <b><?=strtoupper($user->NAMA_UNIT);?></b> </h3>
            </div>
            <div class="widget-container">
                <form class="form-horizontal" method="post" action="<?=base_url().$post_url;?>">
                    <div class="control-group">
                        <label class="control-label"> KODE_GRUP </label>
                        <div class="controls">
                            <select onchange="get_grup(this.value);" required data-placeholder="Pilih kode grup..." class="chzn-select" tabindex="2" style="width:300px;" name="grup" id="grup">
                                <option value=""></option>
                                <?PHP 
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input required type="text" onkeyup="get_kode_akun(this.value);" class="span2" value="" name="kode_sub" id="kode_sub" style="font-size: 14px;">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input required type="text"  class="span6" value="" name="nama_sub" id="nama_sub" style="font-size: 14px;">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input readonly type="text"  class="span6" value="" name="kode_akun" id="kode_akun" style="font-size: 14px;">
                        </div>
                    </div>

                    <div class="form-actions">
                        <?PHP if($user->LEVEL == "USER"){ ?>
                        <input type="submit" class="btn btn-info" name="simpan" value="AJUKAN KODE SUB GRUP">
                        <?PHP } else { ?>
                        <input type="submit" class="btn btn-info" name="simpan" value="SIMPAN KODE SUB GRUP">
                        <?PHP } ?>
...
<div class="row-fluid" id="edit_data" style="display:none;">
    <div class="span12">
        <div class="content-widgets light-gray">
            <div class="widget-head blue">
                <h3> <i class="icon-edit"></i> Ubah Sub Grup Kode Akun </h3>
            </div>
            <div class="widget-container">
                <form class="form-horizontal" method="post" action="<?=base_url().$post_url;?>">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="hidden" class="span12" value="" name="id_sub" id="id_sub" >
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        <label class="control-label"> KODE SUB </label>
                        <div class="controls">
                            <input readonly type="text" class="span2" value="" name="kode_sub_grup_ed" id="kode_sub_grup_ed" style="font-size: 14px;">
                        </div>
                    </div>

                    <div class="control-group">
                        <label class="control-label"> NAMA SUB GRUP </label>
                        <div class="controls">
                            <input required type="text"  class="span6" value="" name="nama_sub_grup_ed" id="nama_sub_grup_ed" style="font-size: 14px;">
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        ...
                        <?PHP } else { ?>
                        <input type="submit" class="btn btn-info" name="edit" value="UBAH KODE SUB GRUP">
                        <?PHP } ?>
...
function get_kode_akun(val){
    var kode_grup = $('#grup').val();
    $('#kode_akun').val(kode_grup+"."+val);
}

function get_grup(val){
    $('#kode_sub').val('');
    $('#nama_sub').val('');
    $('#kode_akun').val(val+".");
}
...
function ubah_data_produk(id){
    $('#popup_load').show();
    $.ajax({
        url : '<?php echo base_url(); ?>sub_grup_kode_akun_c/cari_subgrup_by_id',
        data : {id:id},
        type : "GET",
        dataType : "json",
        success : function(result){
            $('#popup_load').hide();
            $('#id_sub').val(result.ID);
            $('#grup_ed').val(result.KODE_GRUP);
            $('#kode_sub_grup_ed').val(result.KODE_SUB);
            $('#nama_sub_grup_ed').val(result.NAMA_SUB);
