...
<html lang="en">
    <head>
        ...
        .bg { 
            overflow: hidden;
            /* The image used */
            background-image: -webkit-linear-gradient(rgba(0,0,0, 0.4) 0%,rgba(0,0,0, 4) 100%), url(http://images.wookmark.com/149285_mountains-snow-lakes-1920x1080-wallpaper_www.wall321.com_40.jpg);
            background-image:  -moz-linear-gradient(rgba(0,0,0, 0.4) 0%,rgba(0,0,0, 4) 100%), url(http://images.wookmark.com/149285_mountains-snow-lakes-1920x1080-wallpaper_www.wall321.com_40.jpg);
            background-image:  -o-linear-gradient(rgba(0,0,0, 0.4) 0%,rgba(0,0,0,  4) 100%), url(http://images.wookmark.com/149285_mountains-snow-lakes-1920x1080-wallpaper_www.wall321.com_40.jpg);
            background-image:  -ms-linear-gradient(rgba(0,0,0, 0.4) 0%,rgba(0,0,0,  4) 100%), url(http://images.wookmark.com/149285_mountains-snow-lakes-1920x1080-wallpaper_www.wall321.com_40.jpg);
            background-image:  linear-gradient(rgba(0,0,0, 0.4) 0%,rgba(0,0,0,  4) 100%), url(http://images.wookmark.com/149285_mountains-snow-lakes-1920x1080-wallpaper_www.wall321.com_40.jpg);
            /* Full height */
            height: 100%; 
    ...
    <body>
        <div id="bg">
          <img src="http://tamboraagungmakmur.com/img/images/header2.png" alt="">
        </div>
        <!-- Top content -->
