		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-green-haze">
					...
					<span class="caption-subject bold uppercase"> Ubah Data Perintah Membayar Nota (PM) </span>
				</div>
				<div class="actions">
				...
				<form role="form" class="form-horizontal" method="post" action="<?php echo $url_simpan; ?>">
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								<input type="text" class="form-control" id="tgl" name="tgl" readonly value="<?=$dt->TGL;?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								<input type="text" class="form-control" id="kepada" name="kepada" required value="<?=$dt->KEPADA;?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								<textarea class="form-control" name="untuk" style="height: 100px;" required><?=$dt->UNTUK;?></textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								<input type="text" class="form-control text-right" id="nilai" name="nilai" required onkeyup="FormatCurrency(this);" value="<?=number_format($dt->NILAI);?>">
							</div>
						</div>
					</div>
                    ...
                    <div class="form-actions">
						<div class="row">
							<div class="col-md-offset-2 col-md-10">
								...
								<input type="hidden" value="<?=$dt->ID;?>" name="id_edit">
