<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-book"></i> Daftar Mutasi Piutang</h3>
		...
		<ul class="breadcrumb">
			...
			<li class="active"> Daftar Mutasi Piutang </li>
		</ul>
	</div>
</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<div class="input-append" style="width: 50%;">
								<input style="width:100%; background: #FFF; font-size: 12px;" type="text" id="unit_txt" name="unit_txt" value="<?=$user->NAMA_UNIT;?>" readonly>
