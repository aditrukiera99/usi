...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-angle-right"></i> Buat Order Pembelian Barang </h3>
		</div>
		<ul class="breadcrumb">
			<li><a href="#" class="icon-home"></a><span class="divider "><i class="icon-angle-right"></i></span></li>
			<li><a href="#">Pembelian / Penerimaan </a><span class="divider"><i class="icon-angle-right"></i></span></li>
			<li><a href="#">Order Pembelian Barang (OPB) </a><span class="divider"><i class="icon-angle-right"></i></span></li>
			<li class="active"> Buat Order Pembelian Barang </li>
		</ul>
	</div>
</div>
		...
		<div class="content-widgets light-gray">
			...
			<div class="widget-container">
				...
				<div class="form-actions">
					...
					<input type="submit" value="Simpan Order Pembelian" name="simpan" class="btn btn-success">
