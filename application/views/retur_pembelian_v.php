...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-caret-right"></i> Retur Pembelian Barang </h3>
		</div>
		<ul class="breadcrumb">
			<li><a href="#" class="icon-home"></a><span class="divider "><i class="icon-angle-right"></i></span></li>
			<li><a href="#">Pembelian / Penerimaan </a><span class="divider"><i class="icon-angle-right"></i></span></li>
			<li class="active"> Retur Pembelian Barang </li>
		</ul>
	</div>
</div>
...
<div class="row-fluid ">
	<div class="span6">
		<form method="post" action="<?=base_url();?>retur_pembelian_c">
	...
	<div class="span6">
		<button onclick="window.location='<?=base_url();?>retur_pembelian_c/add_new';" style="float: right; margin-top: 12px;" type="button" class="btn btn-inverse opt_btn"> <i class="icon-plus"></i> 
								...
								<td align="center" style="font-size:14px; text-align:center; vertical-align:middle;"> 								
									<div class="btn-group">
										...
										<ul class="dropdown-menu" style="background-color:rgba(255, 255, 255, 1); min-width: 120px;">
											...
											<!-- <li>
											<a href="<?=base_url();?>retur_pembelian_c/ubah_data/<?=$row->ID;?>">Ubah</a>
											</li>
											<?PHP } ?>
											<li>
											<a href="<?=base_url();?>retur_pembelian_c/detail/<?=$row->ID;?>">Detail</a>
											</li> -->
											<li>
											<a target="blank" href="<?=base_url();?>retur_pembelian_c/cetak/<?=$row->ID;?>">Cetak</a>
											</li>
										</ul>
									</div>
								</td>
