...
<div class="row-fluid ">
	<div class="span6">
		<form method="post" action="<?=base_url();?>surat_jalan_c">
						...
						<?PHP  foreach ($dt as $key => $row) { ?>
							<tr>
								...
								<td style="font-size:14px; text-align:center; vertical-align:middle;"> 
									...
									$no_bukti_real = $row->NO_BUKTI."/SJ/MCN.PAS/".$bulan_kas."/".$tahun_kas;
									echo $no_bukti_real;
									?>
								 </td>
								<td style="font-size:14px; text-align:left; vertical-align:middle;">   <?=$row->TGL_SJ;?> </td>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Edit Surat Jalan</h4>
      </div>
