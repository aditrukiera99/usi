...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-plus"></i>  Ubah Bukti Kas Keluar </h3>
		</div>
		<ul class="breadcrumb">
			<li><a href="#" class="icon-home"></a><span class="divider "><i class="icon-angle-right"></i></span></li>
			<li><a href="#">Input Akuntansi</a><span class="divider"><i class="icon-angle-right"></i></span></li>
			<li> Bukti Kas Keluar <span class="divider"><i class="icon-angle-right"></i></span></li>
			<li class="active"> Ubah Bukti Kas Keluar Baru </li>
		</ul>
	</div>
</div>
...
<div class="row-fluid" style="background: #F5EADA; padding-top: 15px; padding-bottom: 15px;">
	<div class="span6">
		<div class="control-group" style="margin-left: 10px;">
			...
			<div class="controls">
				<input type="text" class="span8" value="<?=$dt->NO_VOUCHER;?>" name="no_trx" id="no_trx" readonly style="font-size: 15px;">
			</div>
		</div>
		...
		<div class="control-group" style="margin-left: 10px;">
			...
			<div class="controls">
				<div id="datetimepicker1" class="input-append date ">
					<input readonly style="width: 80%;" value="<?=$dt->TGL;?>" required name="tgl_trx" data-format="dd-MM-yyyy" type="text">
					<span class="add-on ">
		...
		<div class="control-group" style="margin-left: 10px;">
			...
			<div class="controls">
				<div class="input-append">
					<input type="text" id="no_reff" name="no_reff" style="background:#FFF; width: 70%;" value="<?=$dt->NO_BUKTI;?>" readonly>
				</div>
			</div>
		</div>

		<div class="control-group" style="margin-left: 10px;">
			<label class="control-label"> <b style="font-size: 14px;"> Dibayar Kepada </b> </label>			
			<div class="controls">
				<div class="input-append">
					<input type="text" id="pelanggan" name="pelanggan" style="background:#FFF; width: 70%;" value="<?=$dt->KONTAK;?>" readonly>
					<input type="hidden" id="id_pelanggan" name="id_pelanggan" style="background:#FFF; width: 70%;" value="<?=$dt->ID_KONTAK;?>">
				</div>
			</div>
		</div>		
	</div>
	...
	<div class="span6">
		<div class="control-group" style="margin-left: 10px;">
			...
			<div class="controls">
				<textarea rows="4" id="memo" name="memo" style="resize:none; height: 87px; width: 80%;"><?=$dt->URAIAN;?></textarea>
			</div>
		</div> 
		...
		<div class="controls">
			<select  required data-placeholder="Pilih ..." class="chzn-select" tabindex="2"  name="kode_akun_kasbank">
				...
				<?PHP 
				$sel = "";
				foreach ($get_list_akun_bank as $key => $akun_kasbank) { 
					if($akun_kasbank->KODE_AKUN == $dt->KODE_AKUN){
						$sel = "selected";
					} else {
						$sel = "";
					}
				?>
				<option <?=$sel;?> value="<?=$akun_kasbank->KODE_AKUN;?>">  <?=$akun_kasbank->NAMA_AKUN;?></option>
				<?PHP } ?>				
			</select>
		</div>
	</div>
					...
					<tbody id="tes">
						...
						<tr id="tr_<?=$no;?>" class="tr_utama">
							...
							<td style="vertical-align:middle;"> 
								<div class="controls">
									<input style="font-size: 14px; text-align:left; width: 90%;" type="text"  value="<?=$row->KET;?>" name="ket[]" id="ket_<?=$no;?>">
								</div>
							</td>

							<td align="center" style="vertical-align:middle;"> 
								<div class="controls">
									<input onkeyup="FormatCurrency(this);" style="font-size: 14px; text-align:right; width: 80%;" type="text"  value="<?=number_format($row->DEBET);?>" name="nilai[]" id="nilai_<?=$no;?>">
								</div>
							</td>
		...
		<div class="content-widgets light-gray">
			...
			<div class="widget-container">
				...
				<div class="form-actions">
					...
					<button class="btn" onclick="window.location='<?=base_url();?>bukti_kas_keluar_c' " type="button"> Batal dan Kembali </button>
					<input type="submit" value="Ubah Data" name="edit" class="btn btn-success">
					</center>
				</div>
			</div>
		</div>
