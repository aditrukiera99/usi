...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-minus"></i> Bukti Kas Masuk </h3>
		</div>
		<ul class="breadcrumb">
...
<div class="row-fluid ">
	...
	<div class="span6">
		<button onclick="window.location='<?=base_url();?>bukti_kas_masuk_c/add_new';" style="float: right; margin-top: 12px;" type="button" class="btn btn-info opt_btn"> <i class="icon-plus"></i> Buat Bukti Kas Masuk </button>
	</div>
</div>
					...
					<tbody id="tes">
						<?PHP  foreach ($dt as $key => $row) { ?>							
							<tr>								
								...
								<td style="font-size:14px; text-align:right; vertical-align:middle;"> <?=number_format($row->DEBET);?> </td>
								<td align="center">
									<a target="blank" href="<?=base_url();?>bukti_kas_masuk_c/cetak/<?=$row->NO_VOUCHER;?>" class="btn btn-info" type="button" style="font-size: 15px; padding-right: 8px;"><i class="icon-print"></i></a>

									<a class="btn btn-warning" href="<?=base_url();?>bukti_kas_masuk_c/ubah_data/<?=$row->NO_VOUCHER;?>" style="font-size: 15px; padding-right: 8px;"><i class="icon-edit"></i></a>		
