...
header("Content-Disposition: attachment; filename=Laporan_mutasi_piutang.xls");
?>
        ...
        <td style="vertical-align:top;">
            <table align="left" class="grid">
                <tr>
                    ...
                    <th style='text-align:center;' class='kolom_header'> RELASI </th>
                ...
                <tr>
                    ...
                    <td align='left' class='gridtd'><?=$row->NAMA_PELANGGAN;?></td>
