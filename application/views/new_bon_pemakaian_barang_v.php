...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-angle-right"></i> Buat Bon Pemakaian Barang </h3>
		</div>
		<ul class="breadcrumb">
			<li><a href="#" class="icon-home"></a><span class="divider "><i class="icon-angle-right"></i></span></li>
			<li><a href="#">Pembelian / Penerimaan </a><span class="divider"><i class="icon-angle-right"></i></span></li>
			<li><a href="#">Bon Pemakaian Barang (BPB) </a><span class="divider"><i class="icon-angle-right"></i></span></li>
			<li class="active"> Buat Bon Pemakaian Barang </li>
		</ul>
	</div>
</div>
...
<div class="row-fluid" style="background: #F5EADA; padding-top: 15px; padding-bottom: 15px;">
	<div class="span4">
		<div class="control-group" style="margin-left: 10px;">
			<label class="control-label"> <b style="font-size: 14px;"> No. BPB </b> </label>
				<div class="controls">
				...
				<table class="stat-table table table-hover">
					<thead>
						<tr>
							...
							<th align="center" style="display: none;"> Harga </th>
							<th align="center" style="display: none;"> Jumlah</th>
							<th align="center"> No. SPB</th>
							<th align="center"> Aksi</th>
						</tr>						
					</thead>
					<tbody id="tes">
						<tr id="info_none">
							<td colspan="6" style="text-align: center; font-size: 14px;"> Silahkan tambah baris data atau pilih melalui SPB </td>
						</tr>
					</tbody>
				</table>

				<button style="margin-bottom: 15px;" onclick="show_pop_spb();" type="button" class="btn btn-warning"><i class="icon-plus"></i> Include SPB </button>
		...
		<div class="content-widgets light-gray">
			...
			<div class="widget-container">
				...
				<div class="form-actions">
					...
					<input type="submit" value="Simpan Bon Pemakaian Barang" name="simpan" class="btn btn-success">
					<button class="btn" onclick="window.location='<?=base_url();?>bon_pemakaian_barang_c' " type="button"> Batal dan Kembali </button>
					</center>
				</div>
			</div>
		</div>
...
function ajax_spb(){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>order_pembelian_barang_c/get_all_spb',
        type : "POST",
        dataType : "json",
        data : {
            keyword : keyword,
