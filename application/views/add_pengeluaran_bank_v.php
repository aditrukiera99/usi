		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-green-haze">
					...
					<span class="caption-subject bold uppercase"> Form Tambah Data Bukti Bank Keluar </span>
				</div>
				<div class="actions">
				...
				<form role="form" class="form-horizontal" method="post" action="<?php echo $url_simpan; ?>">
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								<input type="text" class="form-control" id="bukti_bank" name="bukti_bank" value="">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-5">
							    <input class="form-control form-control-inline input-medium date-picker" type="text" value="<?=date('d-m-Y');?>" name="tgl_bank" readonly style="background: #FFF; cursor: pointer;"/>
							</div>
						</div>
