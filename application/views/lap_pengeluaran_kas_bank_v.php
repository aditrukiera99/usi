		...
		<div class="content-widgets light-gray">
			<div class="widget-container">
				<form action="<?=base_url().$post_url;?>" method="post" class="form-horizontal" target="_blank">
					<!-- <div class="control-group">
						...
						<div class="controls">
							<div class="input-append" style="width: 50%;">
								<input style="width: 100%; background: #FFF;" type="text" id="unit_txt" name="unit_txt" value="<?=$user->NAMA_UNIT;?>" readonly>
					...
					<div class="control-group">
						<label class="control-label"> <b style="font-size: 14px;"> Jenis Laporan </b> </label>
						<div class="controls">
							<label class="radio">
							<input type="radio" name="jns_laporan" value="no_rinci" checked="">
							Tidak Rinci </label>
							<label class="radio">
							<input type="radio" name="jns_laporan" value="rinci">
							Rinci </label>
						</div>
					</div>
