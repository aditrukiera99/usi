...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-plus"></i>  Penawaran Baru </h3>
		</div>
		<ul class="breadcrumb">
			<li><a href="#" class="icon-home"></a><span class="divider "><i class="icon-angle-right"></i></span></li>
			<li><a href="#">Penjualan</a><span class="divider"><i class="icon-angle-right"></i></span></li>
			<li> Penawaran Barang <span class="divider"><i class="icon-angle-right"></i></span></li>
				...
				<table class="stat-table table table-hover">
					...
					<tbody id="tes">
						<tr id="tr_1" class="tr_utama">
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="controls">
									<input style="font-size: 18px; text-align:left; width: 80%;" type="text"  value="" name="satuan[]" id="satuan_1">
								</div>
							</td>
...
<h4 style="color: #FFF;"> KETERANGAN :</h4> <br>
<textarea name="ket_penawaran">
<ul>
	<li>Harga Include PPN</li>
	<li>Delivery time maksimal 3 Hari setelah PO kami terima</li>
	<li>PO mohon mencantumkan No. Telepon penerima barang dan alamat pengiriman</li>
	<li>Pembayaran termin 14 hari via transfer ke Mandiri No.Rek. 1440077799937 An.PT.Mitra Centra Niaga atau Via Bank BCA No.Rek.0893799777 An. PT Mitra Central Niaga.</li>
	<li>Contact Person : Dede (081234203219).</li>
	<li>Validasi penawaran sampai dengan 17 February 2018.</li>
</ul>
</textarea>
<script>
	CKEDITOR.replace( 'ket_penawaran' );
</script>
		...
		<div class="content-widgets light-gray">
			...
			<div class="widget-container">
				...
				<div class="form-actions">
					...
					<input type="submit" value="Simpan Penawaran" name="simpan" class="btn btn-success">
					<button class="btn" onclick="window.location='<?=base_url();?>penawaran_barang_beli_c' " type="button"> Batal dan Kembali </button>
					</center>
				</div>
			</div>
		</div>
...
function tambah_data() {
	...
	'<tr id="tr_'+i+'" class="tr_utama">'+
		...
		'<td class="center" align="center" style="vertical-align:middle;"> '+
			'<div class="controls">'+
				'<input onkeyup="FormatCurrency(this); always_one('+i+'); hitung_total('+i+');" onchange="" style="font-size: 18px; text-align:center; width: 80%;" type="text"  value="" name="qty[]" id="qty_'+i+'">'+
