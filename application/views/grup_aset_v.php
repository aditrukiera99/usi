				...
				<table class="stat-table table table-hover" id="data-table">
					...
					<tbody id="tes">
						...
						<tr>
							...
							<button onclick="get_grup_data(<?=$row->ID;?>, '<?=$row->GRUP;?>');" type="button" data-toggle='modal' data-target='#modal_edit_kategori' class="btn btn-small btn-warning">
