...
<div class="layout">
			...
			<div class="container">
				...
				<div class="nav-collapse desktop-only">
					...
					<ul class="nav">
                        ...
                        <?php if($this->master_model_m->cek_master($id_user, 'Master Data', $user->LEVEL)){ ?>
                        <li class="dropdown"><a data-toggle="dropdown" class="dropdown-toggle" href="#"><i class="icon-beaker"></i> Produksi <b class="icon-angle-down"></b></a>
                        <div class="dropdown-menu">
                            <ul>
                                <li><a href="<?=base_url();?>barang_produksi_c"><i class="icon-angle-right"></i> Komposisi Produk </a></li>
						...
						<div class="dropdown-menu">
							<ul>
                                <li><a href="<?=base_url();?>lap_penjualan_c"><i class=" icon-book"></i> Laporan Penjualan </a></li>

                                <li><a href="<?=base_url();?>lap_pembelian_c"><i class=" icon-book"></i> Laporan Pembelian </a></li>

                                <li><a href="<?=base_url();?>lap_servis_farmasi_c"><i class=" icon-book"></i> Laporan Service </a></li>
                                ...
                                <!-- <li <?PHP if($view == "lap_komparasi"){ echo "class='active'"; } ?> ><a href="<?=base_url();?>lap_komparasi_c"><i class=" icon-book"></i> Laporan Komparasi</a></li> -->
							</ul>
						</div>
						</li>
                        <?PHP } ?>
		...
		<div class="admin-info clearfix">
			...
			<div class="admin-meta">
				<ul>
					...
					<li class="admin-username" style="color:#1B96FE;"> <?=$user->NAMA_PERUSAHAAN;?> </li>
                    <?PHP } else { ?>
					...
					<li>
                        <?PHP if($user->LEVEL == 'ADMIN'){ ?>
                        <b style="color: #7f181b;">DIREKTUR</b>
                        <?PHP } else { ?>
			...
			<div class="left-secondary-nav tab-content" style="background:#c4dff6;">
				<div class="tab-pane <?PHP if($master == ""){ echo "active"; } ?>" id="main">
					...
					<ul class="metro-sidenav clearfix">
                        ...
                        <li>
                            ...
                            <span class="notify-tip" style="font-size: 15px; padding: 3px;"><?=count($dt_pengajuan_kode_akun);?></span>
                            <?PHP } ?>
                            <a class="blue" href="<?=base_url();?>daftar_kode_akun_c"><i class="icon-tag"></i><span> Kode Akun </span></a>
                        </li>
                        <?PHP } ?>

                        <?php if($this->master_model_m->cek_anak($id_user, 'User Management', $user->LEVEL)){ ?>
                        <li><a class=" blue-violate" href="<?=base_url();?>user_management_c"><i class="icon-user"></i><span> Daftar User </span></a></li>
                        <?PHP } ?>

                        <?php if($this->master_model_m->cek_anak($id_user, 'Produk', $user->LEVEL)){ ?>
                        <li>
                            <?PHP if(count($dt_pengajuan_produk) > 0){ ?>
                            <span class="notify-tip" style="font-size: 15px; padding: 3px;"><?=count($dt_pengajuan_produk);?></span>
                            <?PHP } ?>
                            <a class=" bondi-blue" href="<?=base_url();?>produk_c"><i class="icon-hdd"></i><span> Produk </span></a>
                        </li>
                        <?PHP } ?>
                        ...
                        <li>
                            ...
                            <span class="notify-tip" style="font-size: 15px; padding: 3px; background: #00a4e4;"><?=count($dt_pengajuan_pelanggan);?></span>
                            <?PHP } ?>
                            <a class=" dark-yellow" href="<?=base_url();?>pelanggan_c"><i class="icon-group"></i><span> Pelanggan </span></a>
                        </li>
                        <?PHP } ?>
                        ...
                        <li>
                            ...
                            <span class="notify-tip" style="font-size: 15px; padding: 3px;"><?=count($dt_pengajuan_supplier);?></span>
                            <?PHP } ?>
                            <a class=" blue" href="<?=base_url();?>supplier_c"><i class="icon-truck"></i><span> Supplier </span></a>
                        </li>
                        <?PHP } ?>
                ...
                <div class="tab-pane <?PHP if($master == "produksi"){ echo "active"; } ?>" id="produksi">
                  ...
                  <ul class="accordion-nav">
                      <li <?PHP if($view == "barang_produksi"){ echo "class='active'"; } ?> >
                          <a href="<?=base_url();?>barang_produksi_c"><i class="icon-angle-right"></i> Komposisi Produk
                            <span> Lihat dan Tambahkan daftar komposisi produksi</span> 
                          </a>
                      </li>
				...
				<div class="tab-pane <?PHP if($master == "input_data"){ echo "active"; } ?>" id="forms">
					...
					<ul id="nav" class="accordion-nav">
                        ...
                        <?php if($this->master_model_m->cek_anak($id_user, 'Transaksi Pembelian', $user->LEVEL)){ ?>
                        <li <?PHP if($view == "transaksi_pembelian"){ echo "class='active'"; } ?>><a href="<?=base_url();?>transaksi_pembelian_c"><i class="icon-shopping-cart"></i> Transaksi Pembelian <span> Membuat daftar pembelian / purchase order. </span></a></li>
                        <?PHP } ?>

                        <?php if($this->master_model_m->cek_anak($id_user, 'Transaksi Penjualan', $user->LEVEL)){ ?>
                        <li <?PHP if($view == "transaksi_penjualan"){ echo "class='active'"; } ?>><a href="<?=base_url();?>transaksi_penjualan_c"><i class="icon-random"></i> Transaksi Penjualan <span> Membuat daftar penjualan / sales order. </span></a></li>
					    <?PHP } ?>
	...
	<div class="main-wrapper">        
        ...
        <div class="row-fluid">
            <div class="span12">
                <h3 class=" page-header"><i class="icon-file-alt"></i> LAPORAN unit <b><?=$user->NAMA_UNIT;?></b> </h3>
            </div>
        </div>
        ...
        <div class="row-fluid">
            <div class="span6">
                <h3 class=" page-header"> <i class="icon-camera-retro"></i> LOGO UNIT <b><?=$user->NAMA_UNIT;?></b> </h3>
            ...
            <div class="span6">
                <h3 class=" page-header"> <i class="icon-picture"></i> BACKGROUND UNIT <b><?=$user->NAMA_UNIT;?></b> </h3>
                <form method="post" action="<?=base_url();?>beranda_c" enctype="multipart/form-data">
                <div style="padding: 10px; margin-bottom: 20px;">
                    <div class="control-group">
                        <label class="control-label">  </label>
