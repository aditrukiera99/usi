...
<div class="row-fluid">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-eye-open"></i> Detail Koreksi Persediaan </h3>
		</div>
		<ul class="breadcrumb">
			...
			<li class="active"> Detail Koreksi Persediaan </li>
		</ul>
	</div>
</div>
		...
		<div class="row-fluid" style="background: #F5EADA; padding-top: 15px;">
			<div class="span6">
				<div class="control-group" style="margin-left: 10px;">
					...
					<div class="controls">
						<input required type="text" class="span12" value="<?=$dt->NO_KOREKSI;?>" name="no_koreksi" id="no_koreksi" style="font-size: 15px;">
		...
		<div class="row-fluid" style="background: #F5EADA;">
			<div class="span12">
				<div class="control-group" style="margin-left: 10px;">
					...
					<div class="controls">
						<textarea rows="4" id="catatan" name="catatan" style="resize:none; height: 67px; width: 90%;"><?=$dt->CATATAN;?></textarea>
					</div>
				</div>
			</div>	
		</div>
					...
					<tbody id="tes">	
						...
						<tr id="tr_<?=$no;?>" class="tr_utama">
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="span12">
								<div class="controls">
									<input readonly id="qty_onhand_<?=$no;?>" style="font-size: 18px; text-align:center; width: 50%;" type="text"  value="<?=$row->STOK;?>" name="qty_onhand[]" onkeyup="FormatCurrency(this);">
								</div>
								</div>
							</td>
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="span12">
								<div class="controls">
									<input readonly type="text"  value="<?=$row->HARGA_JUAL;?>" name="harga_satuan_onhand[]" id="harga_satuan_onhand_<?=$no;?>" style="font-size: 18px; text-align:right; width: 80%;" onkeyup="FormatCurrency(this);">
								</div>
								</div>
							</td>						
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="span12">
								<div class="controls">
									<input id="qty_<?=$no;?>" style="font-size: 18px; text-align:center; width: 50%;" type="text"  value="<?=$row->QTY_KOREKSI;?>" name="qty[]" onkeyup="FormatCurrency(this);">
								</div>
								</div>
							</td>
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="span12">
								<div class="controls">
									<input type="text"  value="<?=$row->HARGA_KOREKSI;?>" name="harga_satuan[]" id="harga_satuan_<?=$no;?>" style="font-size: 18px; text-align:right; width: 80%;" onkeyup="FormatCurrency(this);">
								</div>
								</div>
							</td>						
...
<div class="form-actions">
	<center>
	<input type="submit" value="SIMPAN KOREKSI" name="ubah" class="btn btn-info">
	<button class="btn" onclick="window.location='<?=base_url();?>koreksi_persediaan_c' " type="button"> BATAL & KEMBALI </button>
	<button class="btn btn-danger" onclick="$('#dialog-btn').click(); $('#id_hapus').val('<?=$id_koreksi;?>');" type="button"> HAPUS KOREKSI </button>
	</center>
</div>
