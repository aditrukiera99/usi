		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-green-haze">
					...
					<span class="caption-subject bold uppercase"> Form Tambah Data Bukti Kas Keluar </span>
				</div>
				<div class="actions">
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-2 col-md-10">
								<a href="<?=base_url();?>pengeluaran_kas_c" id="batal" class="btn red">Batal Dan Kembali</a>
