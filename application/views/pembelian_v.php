...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-random"></i> Laporan Pembelian </h3>
		</div>
		<ul class="breadcrumb">
...
<div class="row-fluid ">
	...
	<div class="span6">
		<button onclick="window.location='<?=base_url();?>pembelian_c/new_pb';" style="float: right; margin-top: 12px;" type="button" class="btn btn-info opt_btn"> <i class="icon-plus"></i> Buat Pembelian Baru </button>
	</div>
</div>
