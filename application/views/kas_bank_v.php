		...
		<div class="content-widgets light-gray">
			...
			<div class="widget-container">
				<form class="form-horizontal" method="post" action="<?=base_url().$post_url;?>">
					...
					<div class="control-group">
						<label class="control-label"> <b> Debet </b> </label>
						<div class="controls">
							<input required onkeyup="FormatCurrency(this);" type="text" class="span3" value="0" name="saldo_awal" id="saldo_awal">
						</div>
					</div>		

					<div class="control-group">
						<label class="control-label"> <b> Kredit </b> </label>
						<div class="controls">
							<input required onkeyup="FormatCurrency(this);" type="text" class="span3" value="0" name="saldo_awal2" id="saldo_awal2">
						</div>
					</div>					
