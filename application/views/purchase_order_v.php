...
<div class="row-fluid ">
	...
	<div class="span6">
		<button onclick="window.location='<?=base_url();?>purchase_order_c/new_invoice';" style="float: right; margin-top: 12px;" type="button" class="btn btn-info opt_btn"> <i class="icon-plus"></i> Buat Pembelian </button>
					...
					<tbody id="tes">
						<?PHP  foreach ($dt as $key => $row) { ?>
							...
							?>
								...
								<tr>
									<td align="center" style=" background-color: #bdbdbdd6;">
										...
										<a target="blank" href="<?=base_url();?>purchase_order_c/ubah_new_invoice/<?=$row->ID;?>" class="btn btn-warning" type="button" style="font-size: 15px; padding-right: 8px;"><i class="icon-edit"></i></a>					
									...
									<td style="font-size:14px; text-align:left; vertical-align:middle; background-color: #bdbdbdd6;">   <?=$row->NAMA_CUSTOMER;?> </td>
							...
							<?php
									...
									?>
										<tr>
											...
											<td style="font-size:14px; text-align:left; vertical-align:middle; ">   <?=$row->NAMA_CUSTOMER;?> </td>
							...
							<tr>
								...
								<td style="font-size:14px; text-align:left; vertical-align:middle;background-color: #dff0d8; ">   <?=$row->NAMA_CUSTOMER;?> </td>
