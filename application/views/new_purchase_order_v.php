...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-angle-right"></i> Buat Purchase Order </h3>
		</div>
		<ul class="breadcrumb">
			<li><a href="#" class="icon-home"></a><span class="divider "><i class="icon-angle-right"></i></span></li>
			<li><a href="#">Pembelian / Penerimaan </a><span class="divider"><i class="icon-angle-right"></i></span></li>
			<li><a href="#">Purchase Order (PO) </a><span class="divider"><i class="icon-angle-right"></i></span></li>
			<li class="active"> Buat Purchase Order </li>
		</ul>
	</div>
</div>
	...
	<div class="span4">
		<div class="control-group" style="margin-left: 10px;">
			<label class="control-label"> <b style="font-size: 14px;"> No. PO </b> </label>
				<div class="controls">
					<input type="text" id="no_opb" name="no_opb" style="background:#FFF; width: 100%;" value="<?=$no_bukti_real;?>">
				</div>
		</div>
	</div>
		...
		<div class="content-widgets light-gray">
			...
			<div class="widget-container">
				...
				<table class="stat-table table table-hover">
					...
					<tbody id="tes">
						<tr id="info_none">
							<td colspan="8" style="text-align: center; font-size: 14px;"> Silahkan tambah baris data atau pilih melalui OPB </td>
						</tr>
					</tbody>
				</table>
			...
			<div class="widget-container">
				...
				<div class="row-fluid">
					<div class="span3">
						<div class="control-group">
							<div class="controls">
								<label class="control-label"> <b style="font-size: 14px;"> DPP / Dasar Pengenaan Pajak </b> </label>
							    <input style="width: 100%;margin-top: 10px;" value="" name="dpp" type="text" onkeyup="FormatCurrency(this);">
							</div>
						</div>
					</div>
					...
					<div class="span3">
						<div class="control-group">
								<label class="control-label"> <b style="font-size: 14px;"> Include Pajak</b> </label>
							   	<div class="controls" style="    margin-top: 10px; margin-left: 5px;">
									<label class="checkbox inline">
									<input type="checkbox" value="ppn" name="ppn">
									Pajak PPN 10% </label>
								</div>
						</div>
					</div>
				...
				<div class="form-actions">
					...
					<input type="submit" value="Simpan Purchase Order" name="simpan" class="btn btn-success">
					<button class="btn" onclick="window.location='<?=base_url();?>permintaan_barang_c' " type="button"> Batal dan Kembali </button>
					</center>
				</div>
			</div>
		</div>
...
<!-- Modal -->
  <div class="modal fade" id="myModal_spek" role="dialog" style="width: 1000px;left: 36%; display: none;">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 style="color:white;"><span class="glyphicon glyphicon-lock"></span> Spesifikasi</h4>
        </div>
        <div class="modal-body">
        	<!-- A -->
        	<h5>A. As Received (ARB)</h5>
        	<table>
        		<thead>
        		<tr>
	        		<td rowspan="2" style="text-align: center; vertical-align: middle; background: #FFF;">Parameters</td>
	        		<td colspan="3" style="text-align: center; vertical-align: middle; background: #FFF;">TCM</td>
	        		<td colspan="2" style="text-align: center; vertical-align: middle; background: #FFF;">IMM</td>
	        		<td colspan="1" style="text-align: center; vertical-align: middle; background: #FFF;">JBG</td>
	        		<td colspan="2" style="text-align: center; vertical-align: middle; background: #FFF;">BEK</td>
	        		<td colspan="2" style="text-align: center; vertical-align: middle; background: #FFF;">KTD</td>
        		</tr>

        		<tr>
	        		<td style="text-align: center; vertical-align: middle; background: #FFF;">HCV.LS</td>
	        		<td style="text-align: center; vertical-align: middle; background: #FFF;">HCV.HS</td>
	        		<td style="text-align: center; vertical-align: middle; background: #FFF;">LCV.LS</td>

	        		<td style="text-align: center; vertical-align: middle; background: #FFF;">IMM.EAST</td>
	        		<td style="text-align: center; vertical-align: middle; background: #FFF;">IMM.6250</td>

	        		<td style="text-align: center; vertical-align: middle; background: #FFF;">J.1</td>

	        		<td style="text-align: center; vertical-align: middle; background: #FFF;">MCV.LS</td>
	        		<td style="text-align: center; vertical-align: middle; background: #FFF;">MCV.HS</td>

	        		<td style="text-align: center; vertical-align: middle; background: #FFF;">TDM.HCV.HS</td>
	        		<td style="text-align: center; vertical-align: middle; background: #FFF;">EMB</td>
        		</tr>
        		</thead>

        		<tbody>
        			<?PHP 
        			$data = $this->db->query("SELECT * FROM ak_spesifikasi WHERE TIPE = 'A' ")->result();
        			foreach ($data as $key => $row) {
        			?>
        			<tr style="background: #f9f9f9;">
        				<td style="vertical-align: middle;"><?=$row->NAMA;?></td>
        				<td align="center"><input style="vertical-align: middle; text-align: center; width: 40px;" type="text" name="" value=""/></td>
        				<td align="center"><input style="vertical-align: middle; text-align: center; width: 40px;" type="text" name="" value=""/></td>
        				<td align="center"><input style="vertical-align: middle; text-align: center; width: 40px;" type="text" name="" value=""/></td>
        				<td align="center"><input style="vertical-align: middle; text-align: center; width: 40px;" type="text" name="" value=""/></td>
        				<td align="center"><input style="vertical-align: middle; text-align: center; width: 40px;" type="text" name="" value=""/></td>
        	...
        	<table>
        		...
        		<tbody>
        			<?PHP 
        			$data = $this->db->query("SELECT * FROM ak_spesifikasi WHERE TIPE = 'B' ")->result();
        			foreach ($data as $key => $row) {
        			?>
        			<tr style="background: #f9f9f9;">
        				<td style="vertical-align: middle;"><?=$row->NAMA;?></td>
        	...
        	<!-- C -->
        	<h5>C. Ash Fusion Temperature (AFT)</h5>
        	<table>
        		<thead>
        		<tr>
	        		<td rowspan="2" style="text-align: center; vertical-align: middle; background: #FFF;">Parameters</td>
        		...
        		<tbody>
        			<?PHP 
        			$data = $this->db->query("SELECT * FROM ak_spesifikasi WHERE TIPE = 'C' ")->result();
        			foreach ($data as $key => $row) {
        			?>
        			<tr style="background: #f9f9f9;">
        				<td style="vertical-align: middle;"><?=$row->NAMA;?></td>
        	...
        	<table>
        		...
        		<tbody>
        			<?PHP 
        			$data = $this->db->query("SELECT * FROM ak_spesifikasi WHERE TIPE = 'D' ")->result();
        			foreach ($data as $key => $row) {
        			?>
        			<tr style="background: #f9f9f9;">
        				<td style="vertical-align: middle;"><?=$row->NAMA;?></td>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default btn-default pull-left" data-dismiss="modal"> Tutup</button>
          <button type="button" class="btn btn-info btn-default pull-left" data-dismiss="modal"> Simpan</button>
        </div>
      </div>
    </div>
  </div> 
...
function ajax_spb(){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>purchase_order_c/get_all_spb',
        type : "POST",
        dataType : "json",
        data : {
            keyword : keyword,
        ...
        success : function(result){
            ...
            $.each(result,function(i,res){
                no++;
                isine += '<tr onclick="get_more('+res.ID+');" style="cursor:pointer;">'+
		...
		success : function(result){
			...
			$.each(result,function(i,res){
				...
				'<tr id="tr_'+i+'" class="tr_utama">'+
					...
					'<td class="center" align="center" style="vertical-align:middle;"> '+
						'<button class="btn btn-info" data-toggle="modal" data-target="#myModal_spek">Spesifikasi</button>'+
					'</td>'+
