...
$bukti_kas = 'KR'.date('y').date('m').date('d').$no_transaksi;
...
<div class="row-fluid">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-plus"></i> Input Koreksi Persediaan </h3>
		</div>
		<ul class="breadcrumb">
			<li><a href="#" class="icon-home"></a><span class="divider "><i class="icon-angle-right"></i></span></li>
			<li><a href="#">Persediaan</a><span class="divider"><i class="icon-angle-right"></i></span></li>
			<li> Koreksi Persediaan <span class="divider"><i class="icon-angle-right"></i></span></li>
			<li class="active"> Input Koreksi Persediaan </li>
		</ul>
	</div>
</div>
		...
		<div class="row-fluid" style="background: #F5EADA; padding-top: 15px;">
			<div class="span6">
				<div class="control-group" style="margin-left: 10px;">
					<label class="control-label"> <b style="font-size: 14px;"> No Koreksi </b> </label>
					<div class="controls">
						<input required type="text" class="span12" value="<?=$bukti_kas;?>" name="no_koreksi" id="no_koreksi" style="font-size: 15px;">
				...
				<div class="control-group" style="margin-left: 10px;">
					...
					<div class="controls">
						<select tabindex="2" style="width:300px; font-size: 15px;" name="tipe" id="tipe">
							...
							<option value="Quantity2">Quantity & Value</option>
						</select>
					</div>
				</div>
			</div>	
				...
				<div class="control-group" style="margin-left: 10px;">
					...
					<div class="controls">
						<div id="datetimepicker1" class="input-append date ">
							<input style="width: 50%;" value="<?=date('d-m-Y');?>" readonly name="tgl_trx" id="tgl_trx" onclick="$('#add_on_pick').click();" data-format="dd-MM-yyyy" type="text"><span class="add-on "><i id="add_on_pick" data-time-icon="icon-time" data-date-icon="icon-calendar"></i></span>
						</div>
					</div>
				</div>
			</div>	
		...
		<div class="row-fluid" style="background: #F5EADA;">
			<div class="span4">
				<div class="control-group" style="margin-left: 10px;">
					...
					<div class="controls">
						<input type="text" class="span12" value="" name="no_ref" id="no_ref" style="font-size: 15px;">
					</div>
				</div>
			</div>	
		</div>
		...
		<div class="row-fluid" style="background: #F5EADA;">
			<div class="span12">
				<div class="control-group" style="margin-left: 10px;">
					...
					<div class="controls">
						<textarea rows="4" id="catatan" name="catatan" style="resize:none; height: 67px; width: 90%;"></textarea>
					</div>
				</div>
			</div>	
		</div>
		...
		<div class="content-widgets light-gray">
			...
			<div class="widget-container">
				...
				<table class="stat-table table table-hover">
					<thead>
						<tr>
							<th align="center" style="vertical-align: middle; width: 25%;"> Kode Akun </th>
							<th align="center" style="vertical-align: middle; width: 18%;"> Item </th>
							...
							<th align="center" style="vertical-align: middle;"> Qty Koreksi </th>
							<th align="center" style="vertical-align: middle;"> Harga Jual Koreksi </th>
					...
					<tbody id="tes">	
						<tr id="tr_1" class="tr_utama">
									...
									<div class="control-group">
										<div class="controls">
											<div class="input-append">
												<input readonly type="text" id="nama_produk_1" name="nama_produk[]" required style="background:#FFF; width: 70%;">
												<button onclick="show_pop_produk(1);" type="button" class="btn" style="width: 25%;">Cari</button>
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="span12">
								<div class="controls">
									<input readonly id="qty_onhand_1" style="font-size: 18px; text-align:center; width: 50%;" type="text"  value="" name="qty_onhand[]" onkeyup="FormatCurrency(this);">
								</div>
								</div>
							</td>
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="span12">
								<div class="controls">
									<input readonly type="text"  value="" name="harga_satuan_onhand[]" id="harga_satuan_onhand_1" style="font-size: 18px; text-align:right; width: 80%;" onkeyup="FormatCurrency(this);">
								</div>
								</div>
							</td>						
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="span12">
								<div class="controls">
									<input id="qty_1" style="font-size: 18px; text-align:center; width: 50%;" type="text"  value="" name="qty[]" onkeyup="FormatCurrency(this);">
								</div>
								</div>
							</td>
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="span12">
								<div class="controls">
									<input type="text"  value="" name="harga_satuan[]" id="harga_satuan_1" style="font-size: 18px; text-align:right; width: 80%;" onkeyup="FormatCurrency(this);">
								</div>
								</div>
							</td>						
...
<div class="form-actions">
	<center>
	<input type="submit" value="SIMPAN KOREKSI" name="simpan" class="btn btn-info">
	<button class="btn" onclick="window.location='<?=base_url();?>koreksi_persediaan_c' " type="button"> BATAL & KEMBALI </button>
	</center>
</div>
...
function get_produk_detail(id, no_form){
    ...
    $.ajax({
		...
		success : function(result){
			...
			$('#qty_onhand_'+no_form).val(NumberToMoney(result.STOK).split('.00').join(''));
			$('#harga_satuan_onhand_'+no_form).val(NumberToMoney(result.HARGA_JUAL).split('.00').join(''));
...
function tambah_data() {
	...
	'<tr id="tr_'+i+'" class="tr_utama">'+
		...
		'<td align="center" style="vertical-align:middle; text-align:center;"> '+
			'<div class="span12">'+
			'<div class="controls">'+
				'<input readonly id="qty_onhand_'+i+'" style="font-size: 18px; text-align:center; width: 50%;" type="text"  value="" name="qty_onhand[]" onkeyup="FormatCurrency(this);">'+
			'</div>'+
			'</div>'+
		'</td>'+
		...
		'<td align="center" style="vertical-align:middle; text-align:center;"> '+
			'<div class="span12">'+
			'<div class="controls">'+
				'<input readonly type="text"  value="" name="harga_satuan_onhand[]" id="harga_satuan_onhand_'+i+'" style="font-size: 18px; text-align:right; width: 80%;" onkeyup="FormatCurrency(this);">'+
			'</div>'+
			'</div>'+
		'</td>'+
		...
		'<td align="center" style="vertical-align:middle; text-align:center;"> '+
			'<div class="span12">'+
			'<div class="controls">'+
				'<input id="qty_'+i+'" style="font-size: 18px; text-align:center; width: 50%;" type="text"  value="" name="qty[]" onkeyup="FormatCurrency(this);">'+
			'</div>'+
			'</div>'+
		'</td>'+
		...
		'<td align="center" style="vertical-align:middle; text-align:center;">'+
			'<div class="span12">'+
			'<div class="controls">'+
				'<input type="text"  value="" name="harga_satuan[]" id="harga_satuan_'+i+'" style="font-size: 18px; text-align:right; width: 80%;" onkeyup="FormatCurrency(this);">'+
			'</div>'+
			'</div>'+
		'</td>'+
