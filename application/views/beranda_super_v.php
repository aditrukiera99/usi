                    ...
                    <div class="widget-container">
                        ...
                        <div class="form-actions">
                            <center>
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <button type="button" <?PHP if($aktif == 1){ ?> onclick="get_laporan_komp_pend_biaya();" <?PHP } else { echo "disabled";} ?> class="btn btn-info" style="width: 30%;">CETAK KOMPILASI PENDAPATAN DAN BIAYA</button>
...
<script type="text/javascript">
    ...
    function get_laporan_komp_pend_biaya(){
        $('#form_laporan_kompilasi').attr('action', '<?=base_url();?>lap_komparasi_pend_biaya_c');
        $('#cetak_xls_kompilasi').click()
    }
</script>
