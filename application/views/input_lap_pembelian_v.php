...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-plus"></i>  Buat Laporan Pembelian </h3>
		</div>
		<ul class="breadcrumb">
			<li><a href="#" class="icon-home"></a><span class="divider "><i class="icon-angle-right"></i></span></li>
			<li><a href="#">Pembelian</a><span class="divider"><i class="icon-angle-right"></i></span></li>
			<li> Pembelian <span class="divider"><i class="icon-angle-right"></i></span></li>
			<li class="active"> Buat Laporan Pembelian </li>
		</ul>
	</div>
</div>
...
function ajax_pelanggan(){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>pembelian_c/get_po_popup',
        type : "POST",
        dataType : "json",
        data : {
            keyword : keyword,
...
function get_pelanggan_det(id_pel){
	...
	$.ajax({
		...
		success : function(result){
			...
			$('#id_gudang').val(result.SUPPLY_POINT);
		}
	});
}
