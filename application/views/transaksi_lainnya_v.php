...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-exchange"></i>  Transaksi Lainnya </h3>
...
<div class="row-fluid ">
	...
	<div class="span6">
		<button onclick="window.location='<?=base_url();?>transaksi_lainnya_c/new_invoice';" style="float: right; margin-top: 12px;" type="button" class="btn btn-info opt_btn"> <i class="icon-plus"></i> Buat Transaksi Baru </button>
	</div>
</div>
				...
				<table class="responsive table table-striped table-bordered" id="data-table">
					<thead>
						<tr>
							...
							<th align="center"> Status Pembukuan </th>
							...
							<tr>
								...
								<td style="font-size:14px; text-align:center; vertical-align:middle;">
									<?PHP if($row->NO_TRX_AKUN == "" || $row->NO_TRX_AKUN == null ){ 
										...
										echo "<br>";
										echo "<a style='padding: 2px 10px;' href='".base_url()."input_transaksi_akuntansi_c/index/l/".$row->ID."'> (Proses Pembukuan) </a>";
									} else { 
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu" style="background-color:rgba(255, 255, 255, 1); min-width: 120px;"">
										...
										<li>
										<a href="<?=base_url();?>transaksi_lainnya_c/detail/<?=$row->ID;?>" >Detail</a>
										</li>
									</ul>
								</div>
								</td>
