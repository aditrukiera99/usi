...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-random"></i>  Penjualan / Sales Order </h3>
							...
							<tr>
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu" style="background-color:rgba(255, 255, 255, 1); min-width: 120px;">
										...
										<?PHP } ?>
										<li>
										<a href="<?=base_url();?>transaksi_penjualan_c/detail/<?=$row->ID;?>">Detail</a>
										</li>
										<li>
										<a href="<?=base_url();?>transaksi_penjualan_c/cetak/<?=$row->ID;?>">Cetak</a>
										</li>
									</ul>
								</div>
							</td>
