...
<div class="row-fluid ">
	...
	<div class="span6">
		<button onclick="window.location='<?=base_url();?>delivery_order_new_c/new_delivery_order';" style="float: right; margin-top: 12px;" type="button" class="btn btn-info opt_btn"> <i class="icon-plus"></i> Buat Delivery Order </button>
	</div>
</div>
