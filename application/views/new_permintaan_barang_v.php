...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-angle-right"></i> Buat Permintaan Barang </h3>
		</div>
		<ul class="breadcrumb">
			<li><a href="#" class="icon-home"></a><span class="divider "><i class="icon-angle-right"></i></span></li>
			<li><a href="#">Pembelian / Penerimaan </a><span class="divider"><i class="icon-angle-right"></i></span></li>
			<li><a href="#">Permintaan Barang (SPB) </a><span class="divider"><i class="icon-angle-right"></i></span></li>
			<li class="active"> Buat Permintaan Barang </li>
		</ul>
	</div>
</div>
	...
	<div class="span4">
		<div class="control-group" style="margin-left: 10px;">
			<label class="control-label"> <b style="font-size: 14px;"> No. SPB </b> </label>
				<div class="controls">
					<input type="text" id="no_spb" name="no_spb" style="background:#FFF; width: 100%;">
				</div>
		</div>
	</div>
					...
					<tbody id="tes">
						<tr id="tr_1" class="tr_utama">
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="span12">
								<div class="controls">
									<input style="font-size: 18px; text-align:left;" type="text"  value="" name="keterangan[]" id="keterangan_1">
								</div>
								</div>
							</td>
		...
		<div class="content-widgets light-gray">
			...
			<div class="widget-container">
				...
				<div class="form-actions">
					...
					<input type="submit" value="Simpan Permintaan" name="simpan" class="btn btn-success">
...
function tambah_data() {
	...
	'<tr id="tr_'+i+'" class="tr_utama">'+
		...
		'<td align="center" style="vertical-align:middle;"> '+
			'<div class="span12">'+
			'<div class="controls">'+
				'<input style="font-size: 18px; text-align:left;" type="text"  value="" name="keterangan[]" id="keterangan_'+i+'">'+
			'</div>'+
			'</div>'+
		'</td>'+
