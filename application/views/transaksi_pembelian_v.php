...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-shopping-cart"></i>  Pembelian / Purchase Order </h3>
							...
							<tr>
								...
								<td style="font-size:14px; text-align:center; vertical-align:middle;"> 
									<?PHP if($row->NO_TRX_AKUN == "" || $row->NO_TRX_AKUN == null ){ 
										...
										echo "<br>";
										echo "<a style='padding: 2px 10px;' href='".base_url()."input_transaksi_akuntansi_c/index/b/".$row->ID."'> (Proses Pembukuan) </a>";
									} else { 
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu" style="background-color:rgba(255, 255, 255, 1); min-width: 120px;">
										...
										<li>
										<a href="<?=base_url();?>transaksi_pembelian_c/cetak/<?=$row->ID;?>">Cetak</a>
										</li>
									</ul>
								</div>
							</td>
