	...
	<div class="span12">
		<div class="primary-head">
			...
			<button type="button" class="btn btn-info view_data" onclick="tambah_klik();" style="float: right;"> 
				<i class="icon-plus" style="color: #FFF; font-size: 16px; left: 0; position: relative; top: 2px;"></i> TAMBAH TRANSPORTIR
			</button>
		</div>
		<ul class="breadcrumb">
			<li><a href="#" class="icon-home"></a><span class="divider "><i class="icon-angle-right"></i></span></li>
			<li><a href="#">Master Data</a><span class="divider"><i class="icon-angle-right"></i></span></li>
			<li class="active"> Transportir </li>
		</ul>
	</div>
</div>
				...
				<table class="responsive table table-striped table-bordered" id="data-table">
					<thead>
						<tr>
							...
							<th align="center"> NAMA TRANSPORTIR </th>						
							<th align="center"> ALAMAT TRANSPORTIR </th>						
	...
	<div class="span12">
		<div class="content-widgets light-gray">
			<div class="widget-head blue">
				<h3> <i class="icon-plus"></i> Tambah Transportir </h3>
			</div>
			<div class="widget-container">
				<form class="form-horizontal" method="post" action="<?=base_url().$post_url;?>">
					<div class="control-group">
						...
						<div class="controls">
							<input required type="text" class="span6" value="" name="nama_master_transportir" style="font-size: 14px;">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input required type="text" class="span6" value="" name="alamat_master_transportir" style="font-size: 14px;">
						</div>
					</div>
