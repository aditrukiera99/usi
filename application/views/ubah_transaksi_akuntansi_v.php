	...
	<div>
		<div class="span6">
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-append">
						<input type="text" id="no_trx_akun" name="no_trx_akun" readonly style="background:#FFF; width: 80%;">
			...
			<div class="control-group">
				...
				<div class="controls">
						<input style="width: 80%;" type="text" id="no_bukti" name="no_bukti" value="" readonly style="background:#FFF;">
				</div>
			</div>			
				...
				<label class="control-label"> <b style="font-size: 14px;"> Tanggal Transaksi </b> </label>
					<div class="controls">
						<div id="datetimepicker1" class="input-append date ">
							<input style="width: 80%;"  value="<?=date('d-m-Y');?>" readonly name="tgl_trx" id="tgl_trx" onclick="$('#add_on_pick').click();" data-format="dd-MM-yyyy" type="text"><span class="add-on "><i id="add_on_pick" data-time-icon="icon-time" data-date-icon="icon-calendar"></i></span>
						</div>
					</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-append">
						<input style="width: 80%;"  type="text" id="tipe" name="tipe" value="" readonly>
					</div>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-append">
						<input style="width: 80%;"  type="text" id="kontak" name="kontak" value="" readonly>
					</div>
				</div>
			</div>
		...
		<div class="span6">
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-append">
						<input style="width: 80%;"  type="text" id="pajak" name="pajak" value="" readonly>
					</div>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-append">
						<input style="width: 80%;"  type="text" id="nilai_pajak" name="nilai_pajak" value="" readonly>
					</div>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-append">
						<input style="width: 80%;"  type="text" id="nilai_total" name="nilai_total" value="" readonly>
					</div>
				</div>
			</div>
...
<div class="row-fluid" style="background: #F5EADA;">
	<div class="span3" style="margin-left: 10px;">
		<div class="control-group">
				...
				<div class="controls">
					<select  data-placeholder="Pilih ..." class="chzn-select" tabindex="2" id="kode_akun_add" name="kode_akun_add">
