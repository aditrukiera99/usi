...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-caret-right"></i> Bon Pemakaian Barang (BPB) </h3>
		</div>
		<ul class="breadcrumb">
			<li><a href="#" class="icon-home"></a><span class="divider "><i class="icon-angle-right"></i></span></li>
			<li><a href="#">Produksi </a><span class="divider"><i class="icon-angle-right"></i></span></li>
			<li class="active"> Bon Pemakaian Barang (BPB)  </li>
		</ul>
	</div>
</div>
...
<div class="row-fluid ">
	<div class="span6">
		<form method="post" action="<?=base_url();?>bon_pemakaian_barang_c">
	...
	<div class="span6">
		<button onclick="window.location='<?=base_url();?>bon_pemakaian_barang_c/add_new';" style="float: right; margin-top: 12px;" type="button" class="btn btn-inverse opt_btn"> <i class="icon-plus"></i> Buat Bon Pemakaian Barang </button>
	</div>
</div>
								...
								<td align="center" style="font-size:14px; text-align:center; vertical-align:middle;"> 								
									<div class="btn-group">
										...
										<ul class="dropdown-menu" style="background-color:rgba(255, 255, 255, 1); min-width: 120px;">
											...
											<li>
											<a target="blank" href="<?=base_url();?>bon_pemakaian_barang_c/cetak/<?=$row->ID;?>">Cetak</a>
											</li>
										</ul>
									</div>
								</td>
