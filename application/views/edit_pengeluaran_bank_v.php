		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-green-haze">
					...
					<span class="caption-subject bold uppercase"> Form Ubah Data Bukti Bank Keluar </span>
				</div>
				<div class="actions">
				...
				<form role="form" class="form-horizontal" method="post" action="<?php echo $url_simpan; ?>">
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								<input type="text" class="form-control" id="kepada" name="kepada" value="<?=$dt->KEPADA;?>">
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-md-2 control-label" for="form_control_1">Tanggal bank</label>
							<div class="col-md-5">
							    <input class="form-control form-control-inline input-medium date-picker" type="text" value="<?=$dt->TGL_BANK;?>" name="tgl_bank" readonly style="background: #FFF; cursor: pointer;"/>
							</div>
						</div>
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-2 col-md-10">
								<a href="<?=base_url();?>pengeluaran_bank_c" id="batal" class="btn red">Batal Dan Kembali</a>
