...
<div class="row-fluid ">
	<div class="span12">
		...
		<ul class="breadcrumb">
			...
			<li class="active"> Buat Pembelian Umum </li>
		</ul>
	</div>
</div>
	...
	<div class="span6">
		...
		<div class="control-group" style="margin-left: 10px;">
			<label class="control-label"> <b style="font-size: 14px;"> Supply Point </b> </label>
				<div class="controls">
					<select class="span8" name="supply_point">
						<?php 
				...
				<table class="stat-table table table-hover">
					<thead>
						<tr>
							...
							<th align="center" style="width: 15%;"> Harga Satuan </th>
						...
						<tr id="tr_1" class="tr_utama">
							...
							<td style="vertical-align:middle;"> 
								...
								<div class="control-group">
									<div class="controls">
										<div class="input-append">
											<input type="text" id="nama_produk_1" name="nama_produk[]" style="background:#FFF; width: 90%;">
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="controls">
									...
									<input type="hidden" name="total_produk[]" id="total_produk_1">
			...
			<div class="widget-container">
				...
				<div class="form-actions">
					...
					<div class="row-fluid" style="margin-top: 10px;">
						...
						<div style="margin-bottom: 15px;" class="span4">
							<h3 style="color: green;" id="sub_total">Rp</h3>
					...
					<input type="submit" value="Simpan Pembelian" name="simpan_umum" class="btn btn-success">
	...
	'<tr id="tr_'+i+'" class="tr_utama">'+
		...
		'<td style="vertical-align:middle;" id="td_chos_'+i+'">'+
			'<div class="control-group">'+
				'<div class="controls">'+
					'<div class="input-append">'+
						'<input type="text" id="nama_produk_'+i+'" name="nama_produk[]" style="background:#FFF; width: 90%">'+
		...
		'<td class="center" style="vertical-align:middle;"> '+
			'<div class="controls">'+
				...
				'<input type="hidden" name="total_produk[]" id="total_produk_'+i+'">'+
			'</div>'+
		'</td>'+
