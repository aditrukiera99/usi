...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-plus-sign"></i>  Input Jurnal Umum</h3>
		</div>
		<ul class="breadcrumb">
			<li><a href="#" class="icon-home"></a><span class="divider "><i class="icon-angle-right"></i></span></li>
			<li><a href="#">Input Akuntansi</a><span class="divider"><i class="icon-angle-right"></i></span></li>
			<li class="active"> Input Jurnal Umum</li>
		</ul>
	</div>
</div>
	...
	<div>
		<div class="span6">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="no_trx_akun" name="no_trx_akun" value="<?=$no_transaksi.".".date('m').".".date('Y')."/TA";?>" style="background:#FFF; width: 90%;" required>
				</div>
			</div>
