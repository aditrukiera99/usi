<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-group"></i>  User Management </h3>
...
<div class="row-fluid">
	<div class="span12">
		<span style="float:right;">
			<a href="<?=base_url();?>user_management_c/add_new_user" class="btn btn-success"> 
				<i class="icon-plus" style="color: #FFF; font-size: 16px; left: 0; position: relative; top: 2px;"></i> Tambah Data User 
			</a>
		</span>
	</div>
</div>
			...
			<div class="widget-container">				
				...
				<tr>
					...
					<td style="text-align:center;">
						<a href="<?=base_url();?>user_management_c/kelola_akses/<?=$row->ID;?>" class="btn btn-primary">Kelola Hak Akses</a>
					</td>
					<td style="text-align:center;">
