<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-book"></i> Laporan Daftar Supplier</h3>
		...
		<ul class="breadcrumb">
			...
			<li class="active"> Laporan Daftar Supplier</li>
		</ul>
	</div>
</div>
			...
			<div class="widget-container">
				<form action="<?=base_url().$post_url;?>" method="post" class="form-horizontal" target="_blank">
					...
					<div class="form-actions">
						<input type="submit" value="Cetak Laporan Daftar Supplier" name="pdf" class="btn btn-danger">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
