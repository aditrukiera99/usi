...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-tags"></i>  Daftar Mareketing </h3>
			<button type="button" class="btn btn-info view_data" onclick="tambah_klik();" style="float: right;"> 
				<i class="icon-plus" style="color: #FFF; font-size: 16px; left: 0; position: relative; top: 2px;"></i> TAMBAH Mareketing 
			</button>
		</div>
		<ul class="breadcrumb">
			<li><a href="#" class="icon-home"></a><span class="divider "><i class="icon-angle-right"></i></span></li>
			<li><a href="#">Master Data</a><span class="divider"><i class="icon-angle-right"></i></span></li>
			<li class="active"> Mareketing </li>
		</ul>
	</div>
</div>
				...
				<table class="stat-table table table-hover" id="data-table">
					<thead>
						<tr>
							...
							<th align="center"> Nama Marketing</th>
							<th align="center"> Alamat Marketing </th>
	...
	<div class="span12">
		<div class="content-widgets light-gray">
			<div class="widget-head blue">
				<h3> <i class="icon-plus"></i> Tambah Data marketing </h3>
			</div>
			<div class="widget-container">
				<form class="form-horizontal" method="post" action="<?=base_url().$post_url;?>">
					<div class="control-group">
						<label class="control-label orang_show"> <b> Nama Marketing </b> </label>
						<div class="controls">
							<input required type="text" placeholder="Nama Marketing"  class="span12" value="" name="nama_broker">
						</div>
					</div>
					...
					<div class="control-group">
						<label class="control-label"> <b> Alamat Marketing </b> </label>
						<div class="controls">
					...
					<div class="form-actions">
                        <input type="submit" class="btn btn-info" name="simpan" value="SIMPAN MARKETING">
...
<div class="row-fluid" id="edit_data" style="display:none;">
	<div class="span12">
		<div class="content-widgets light-gray">
			<div class="widget-head blue">
				<h3> <i class="icon-edit"></i> Ubah Data Marketing </h3>
			</div>
			<div class="widget-container">
				<form class="form-horizontal" method="post" action="<?=base_url().$post_url;?>">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<input required type="text" placeholder="Nama Marketing"  class="span12" value="" name="nama_broker_ed">
						</div>
					</div>
					...
					<div class="form-actions">
                        <input type="submit" class="btn btn-info" name="edit" value="UBAH MARKETING">
