...
<input id="tr_utama_count" value="<?=$dt_count->HITUNG;?>" type="hidden"/>
<input id="tr_utama_count2" value="<?=$dt_count1->HITUNG_CUST;?>" type="hidden"/>
<div class="row-fluid ">
	<div class="span12">
	...
	<div class="row-fluid">
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-append">
						...
						<input type="hidden" id="pelanggan_sel" value="<?=$dt->ID_PELANGGAN;?>" name="pelanggan_sel" readonly style="background:#FFF;">
						<input type="hidden" id="kota_tujuan" value="<?=$dt->KOTA;?>" name="kota_tujuan" readonly style="background:#FFF;">
		...
		<div class="span3">
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-append">
						<input type="text" id="atas_nama" name="atas_nama" style="background:#FFF; width: 90%" value="<?=$dt->ATAS_NAMA;?>">
					</div>
				</div>
			</div>
		</div>
...
<div class="row-fluid" style="background: #F5EADA; padding-top: 15px; padding-bottom: 15px;">
	<div class="span6">
		...
		<div class="control-group" style="margin-left: 10px;">
			<label class="control-label"> <b style="font-size: 14px;"> Alamat Tujuan </b> </label>
				<div class="controls">
					<textarea rows="4" id="alamat_tagih" name="alamat_tagih" style="resize:none; height: 87px; width: 90%;"><?=$dt->ALAMAT_TUJUAN;?></textarea>
				</div>
		</div>
			...
			<label class="control-label"> <b style="font-size: 14px;"> Tanggal Pengambilan </b> </label>
				<div class="controls">
					<div id="datetimepicker2" class="input-append date ">
						<input readonly style="width: 80%;" value="<?=$dt->TGL_PENGAMBILAN;?>" required name="tgl_ambil" data-format="dd-MM-yyyy" type="text">
						<span class="add-on ">
							<i class="icon-calendar"></i>
						</span>
					</div>
	...
	<div class="span6">
		...
		<div class="control-group" style="margin-left: 10px;">
			...
			<div class="controls">
				<input type="text" class="span8" value="<?=$dt->TRANSPORT;?>" name="transport" id="transport" style="font-size: 15px;">
			</div>
		</div>
		...
		<div class="control-group" style="margin-left: 10px;">
			...
			<div class="controls">
				<input type="text" class="span8" value="<?=$dt->NO_POL;?>" name="no_pol" id="no_pol" style="font-size: 15px;">
			</div>
		</div>
		...
		<div class="control-group" style="margin-left: 10px;">
			...
			<div class="controls">
				<input type="text" class="span8" value="<?=$dt->SOPIR;?>" name="sopir" id="sopir" style="font-size: 15px;">
			</div>
		</div>
		...
		<div class="control-group" style="margin-left: 10px; >
			...
			<div class="controls">
				...
				<input type="hidden" class="span8" value="<?=$dt->ID;?>" name="id_penjualan" id="alat_angkut" style="font-size: 15px;">
			</div>
		</div>
		...
		<div class="control-group" style="margin-left: 10px; ">
			...
			<div class="controls">
				<input type="text" class="span8" value="<?=$dt->SEGEL_BAWAH;?>" name="segel_bawah" id="segel_bawah" style="font-size: 15px;">
			</div>
		</div>
		...
		<table class="stat-table table table-hover" style="width: 90%;">
			<thead>
				<tr>
					...
					<th align="center" style="width: 80%;"> Nama Customer </th>
			...
			<tbody id="data_cust">
				...
				<tr id="tr2_<?=$i;?>">
					...
					<td><input value="<?=$value->NAMA_CUSTOMER;?>" type="text" name="data_cust[]" class="span12"></td>
					<td><button style="width: 100%;" onclick="hapus_row1('<?=$i;?>');" type="button" class="btn btn-danger"> Hapus </button></td>
				</tr>
				<?php } ?>
			</tbody>
			<tfoot>
		...
		<div class="content-widgets light-gray">
			...
			<div class="widget-container">
				...
				<table class="stat-table table table-hover">
					...
					<tbody id="tes">
						<?php foreach ($dt_detail as $key => $detail) {
						...
						<tr id="tr_1" class="tr_utama">
							...
							<td style="vertical-align:middle;"> 
								...
								<div class="control-group">
									<div class="controls">
										<div class="input-append">
											<input type="text" id="nama_produk_1" name="nama_produk[]" readonly style="background:#FFF; width: 60%;" value="<?=$detail->NAMA_PRODUK;?>">
											<input type="hidden" value="<?=$detail->ID_PRODUK;?>" id="id_produk_1" name="produk[]" readonly style="background:#FFF;">
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="controls">
									<input onkeyup="FormatCurrency(this); always_one(1); hitung_total(1);" onchange="" id="qty_1" style="font-size: 18px; text-align:center; width: 80%;" type="text"  value="<?=number_format($detail->QTY);?>" name="qty2[]">
									<input onkeyup="FormatCurrency(this); always_one(1); hitung_total(1);" onchange="" id="qty_1" style="font-size: 18px; text-align:center; width: 80%;" type="hidden"  value="<?=number_format($detail->QTY);?>" name="qty[]">
								</div>
							</td>

							<td align="center" style="vertical-align:middle;"> 
								<div class="controls">
									<input onkeyup="FormatCurrency(this); hitung_total(1);" style="font-size: 18px; text-align:right; width: 80%;" type="text"  value="<?=number_format($detail->MODAL);?>" name="harga_modal2[]" id="harga_modal_1">
									<input onkeyup="FormatCurrency(this); hitung_total(1);" style="font-size: 18px; text-align:right; width: 80%;" type="hidden"  value="<?=$detail->MODAL;?>" name="harga_modal[]" id="harga_modal_1">
								</div>
							</td>

							<td align="center" style="vertical-align:middle;"> 
								<div class="controls">
									<input required onkeyup="FormatCurrency(this);" style="font-size: 18px; text-align:right; width: 80%;" type="text"  value="<?=number_format($detail->HARGA_INVOICE);?>" name="harga_invoice2[]" id="harga_invoice_1">
									<input required onkeyup="FormatCurrency(this);" style="font-size: 18px; text-align:right; width: 80%;" type="hidden"  value="<?=$detail->HARGA_INVOICE;?>" name="harga_invoice[]" id="harga_invoice_1">
								</div>
							</td>
		...
		<div class="content-widgets light-gray">
			...
			<div class="widget-container">
				...
				<div class="form-actions">
					...
					<input type="submit" value="Simpan Pembelian" name="simpan_ciu" class="btn btn-success">
...
function hitung_total(id){
	...
	$('#harga_invoice_'+id).val(acc_format(profit,""));
}
