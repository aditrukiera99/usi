...
<a href="<?=base_url();?>jurnal_final_c/add_new" class="btn green">
	...
	<div class="col-md-12">
		...
		<div class="portlet box green">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-edit"></i>Data Jurnal Final
				</div>
				<div class="tools">
			...
			<div class="portlet-body">
				...
				<tr>
					...
					<td style="text-align:center; vertical-align: middle;">
						<a class="btn default btn-xs purple" id="ubah" href="<?=base_url();?>jurnal_final_c/edit/<?=$value->ID;?>"><i class="fa fa-edit"></i> Ubah </a>
