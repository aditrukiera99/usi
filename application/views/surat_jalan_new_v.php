...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-random"></i> Surat Jalan </h3>
		</div>
		<ul class="breadcrumb">
						...
						<?PHP  foreach ($dt as $key => $row) { ?>
							...
							<tr>
								<td align="center">						
									...
									<a target="blank" href="<?=base_url();?>transaksi_penjualan_c/cetak_sj/<?=$row->ID;?>" class="btn btn-success" type="button" style="font-size: 15px; padding-right: 8px;"><i class="icon-print"></i></a>
								</td>
								
								<td style="font-size:14px; text-align:left; vertical-align:middle;text-align: center;">   <?=$row->NO_SJ;?> /SJ</td>
