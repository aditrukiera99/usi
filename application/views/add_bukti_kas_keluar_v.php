...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-plus"></i>  Buat Bukti Kas Keluar </h3>
		</div>
		<ul class="breadcrumb">
			...
			<li class="active"> Buat Bukti Kas Keluar Baru </li>
		</ul>
	</div>
</div>
...
<div class="row-fluid" style="background: #F5EADA; padding-top: 15px; padding-bottom: 15px;">
	<div class="span6">
		...
		<div class="control-group" style="margin-left: 10px;">
			...
			<div class="controls">
				<input type="text" class="span8" value="MK<?=$no_transaksi;?>" name="no_trx" id="no_trx" readonly style="font-size: 15px;">
