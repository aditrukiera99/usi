<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-book"></i> Laporan Kompilasi Laba Rugi</h3>
		...
		<ul class="breadcrumb">
			...
			<li class="active"> Laporan Kompilasi Laba Rugi </li>
		</ul>
	</div>
</div>
			...
			<div class="widget-container">
				<form action="<?=base_url().$post_url;?>" method="post" class="form-horizontal" target="_blank">
					<div class="control-group">
						...
						<div class="controls">
							<div class="input-append" style="width: 50%;">
								<input style="background: #FFF; font-size: 12px; width: 100%;" type="text" id="unit_txt" name="unit_txt" value="<?=$user->NAMA_UNIT;?>" readonly class="span12">
					...
					<div class="form-actions">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
						<input type="submit" value="Cetak Laporan Kompilasi Laba Rugi" name="excel" class="btn btn-info">
					</div>
				</form>
			</div>
		</div>
