...
<div class="row-fluid">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-plus"></i> Input Komposisi Produk  </h3>
		</div>
		<ul class="breadcrumb">
			...
			<li class="active"> Input Komposisi Produk   </li>
		</ul>
	</div>
</div>
		...
		<div class="row-fluid" style="background: #F5EADA; padding-top: 15px; padding-left: 15px;">
			<div class="span6">
				<div class="control-group" style="margin-left: 10px;">
					<label class="control-label"> <b style="font-size: 14px;"> Pilih Barang Jadi </b> </label>
					<div class="controls">
					...
					<tbody id="tes">	
						<tr id="tr_1" class="tr_utama">
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="span12">
								<div class="controls">
									<input readonly id="kode_item_1" style="font-size: 15px; text-align:center; width: 50%;" type="text"  value="" name="kode_item[]">
								</div>
								</div>
							</td>
							...
							<td align="center" style="vertical-align:middle;"> 
								<div class="span12">
								<div class="controls">
									<input readonly id="stok_1" style="font-size: 15px; text-align:center; width: 50%;" type="text"  value="" name="stok[]">
								</div>
								</div>
							</td>
							...
							<td align="center" style="vertical-align:middle;"> 
								...
								<div class="controls">
									<div class="input-append">
										<input id="qty_1" type="text" value="" name="qty[]" required style="font-size: 15px; text-align:center; width: 30%;" onkeyup="FormatCurrency(this);">
										<input id="satuan_item_1" type="hidden" value="" name="satuan[]">
										<span class="add-on" id="satuan_1">Kg</span>
									</div>
								</div>
								</div>
							</td>				
...
<div class="form-actions">
	<center>
	<input type="submit" value="SIMPAN KOMPOSISI PRODUK" name="simpan" class="btn btn-info">
