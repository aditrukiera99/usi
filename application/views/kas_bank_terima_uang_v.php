...
<div class="row-fluid ">
	<div class="span12">
		<div class="primary-head">
			<h3 class="page-header"> <i class="icon-money"></i>  Kas & Bank (Terima Uang) </h3>
...
<div class="row-fluid" style="background: #F5EADA; padding-top: 15px; padding-bottom: 15px;">
	<div class="span4">
		<div class="control-group" style="margin-left: 20px;">
			<label class="control-label"> <b style="font-size: 14px;"> Yang Membayar </b> </label>
				<div class="controls">
	...
	<div class="span4">
		<div class="control-group" style="margin-left: 10px;">
			...
			<div class="controls">
				<input readonly type="text" class="span8" value="WD-<?=$no_transaksi;?>" name="no_trx" id="no_trx">
		...
		<div class="content-widgets light-gray">
			...
			<div class="widget-container">
				...
				<table class="stat-table table table-hover">
					<thead>
						<tr>
							<th align="center"> Terima Dari </th>
		...
		<div class="content-widgets light-gray">
			...
			<div class="widget-container">
				...
				<div class="form-actions">
					...
					<input type="submit" value="Simpan Penerimaan" name="simpan" class="btn btn-success">
