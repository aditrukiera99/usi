...
<div class="row-fluid ">
	...
	<div class="span6">
		<button onclick="window.location='<?=base_url();?>penawaran_barang_c/new_input';" style="float: right; margin-top: 12px;" type="button" class="btn btn-info opt_btn"> <i class="icon-plus"></i> Buat Penawaran Baru </button>
	</div>
</div>
