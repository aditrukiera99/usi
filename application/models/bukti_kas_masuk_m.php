...
class Bukti_kas_masuk_m extends CI_Model
{
    ...
    function get_data_trx_detail($no_voucher){
        ...
        WHERE NO_VOUCHER_DETAIL = '$no_voucher' AND KREDIT > 0
        ";
    ...
    function update_nilai_voucher($no_trx, $nilai_total){
        ...
        $sql = "
        UPDATE ak_input_voucher SET DEBET = '$nilai_total'
