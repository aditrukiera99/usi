...
class Retur_pembelian_m extends CI_Model
{
    ...
    function get_pembelian($keyword, $id_klien){
        ...
        $sql = "
        SELECT * FROM ak_pembelian WHERE $where_unit AND TIPE = 'RETUR'
        ORDER BY ID DESC
        ";
    ...
    function get_pembelian_filter($keyword, $id_klien, $tgl_awal, $tgl_akhir){
        ...
        $sql = "
        SELECT * FROM ak_pembelian WHERE $where AND $where_unit AND TIPE = 'RETUR'
        ORDER BY ID DESC
        ";
    ...
    function simpan_order_pembelian_barang($unit, $no_opb, $tgl_trx, $uraian, $unit, $dpp, $ppn, $id_pelanggan, $pelanggan, $no_po){
        ...
        VALUES 
        ('$no_opb', '$tgl_trx', 'RETUR', '$uraian', '$unit', '$dpp', '$ppn', '$id_pelanggan', '$pelanggan', '$no_po')
        ";
