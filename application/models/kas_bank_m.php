...
class Kas_bank_m extends CI_Model
{
    ...
    function get_kas_bank($keyword, $id_klien){
        ...
        WHERE $where_unit AND a.DEBET > 0
        ORDER BY ID DESC
        ";
    ...
    function simpan_saldo_awal($id_klien, $nomor_akun, $tgl, $saldo_awal, $des){
        ...
        (ID_KLIEN, KODE_AKUN, NO_BUKTI, TGL, DEBET, KREDIT, DESKRIPSI, TIPE, UNIT)
        VALUES 
        ($id_klien, '$nomor_akun', 'Saldo Awal', '$tgl', '$saldo_awal', 0, '$des', 'SA', '$unit')
        ";
    ...
    function simpan_ekuitas_saldo($id_klien, $nomor_akun, $tgl, $saldo_awal, $des_ekuitas){
        ...
        (ID_KLIEN, KODE_AKUN, NO_BUKTI, TGL, DEBET, KREDIT, DESKRIPSI, TIPE, UNIT)
        VALUES 
        ($id_klien, '300.01.01', 'Saldo Awal', '$tgl', 0, $saldo_awal, '$des_ekuitas', 'EK', '$unit')
        ";
