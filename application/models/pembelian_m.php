...
class Pembelian_m extends CI_Model
{
    ...
    function simpan_pembelian($no_lpbe, $id_supplier, $supplier, $keterangan, $no_po , $id_gudang ,$tgl_trx)
    {
    ...
    function get_data_trx_depan(){
        $sql = "
        SELECT * FROM ak_pembelian WHERE NO_PO_INVOICE != ''
        ";
    ...
    function update_tanggal_penerimaan($id){
        ...
        $sql = "
        UPDATE ak_pembelian SET TGL_TRX = '$tgj' , STATUS = '1'
        WHERE ID = '$id'
        ";
