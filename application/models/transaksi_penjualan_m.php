...
class Transaksi_penjualan_m extends CI_Model
{
    ...
    function get_penjualan($keyword, $id_klien){
        ...
        $sql = "
        SELECT * FROM ak_penjualan WHERE ID_KLIEN = $id_klien AND $where_unit
        ORDER BY ID DESC
        ";
    ...
    function get_data_trx($id){
        $sql = "
        SELECT a.*, b.NAMA_UNIT , c.NO_TELP FROM ak_penjualan a
    ...
    function get_data_trx_detail($id){
        ...
        SELECT a.*, b.NAMA_AKUN FROM ak_penjualan_detail a 
    ...
    function get_penjualan_filter($keyword, $id_klien, $tgl_awal, $tgl_akhir){
        ...
        $sql = "
        SELECT * FROM ak_penjualan WHERE ID_KLIEN = $id_klien AND $where AND $where_unit
        ORDER BY ID DESC
        ";
