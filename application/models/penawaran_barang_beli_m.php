...
class Penawaran_barang_beli_m extends CI_Model
{
    ...
    function get_penjualan($keyword, $id_klien){
        ...
        $sql = "
        SELECT * FROM ak_pembelian WHERE ID_KLIEN = $id_klien AND $where_unit AND TIPE = 'PENAWARAN_BELI'
        ORDER BY ID DESC
        ";
    ...
    function get_data_trx_detail_ubah($id){
        $sql = "
        SELECT * FROM ak_pembelian_detail
        WHERE ID_PENJUALAN = '$id'
        ";
    ...
    function hapus_trx_penjualan($id_hapus){
        ...
        $sql_2 = "
        DELETE FROM ak_pembelian_detail WHERE ID_PENJUALAN = $id_hapus
        ";
    ...
    function get_penjualan_filter($keyword, $id_klien, $tgl_awal, $tgl_akhir){
        ...
        $sql = "
        SELECT * FROM ak_pembelian WHERE ID_KLIEN = $id_klien AND $where AND $where_unit AND TIPE = 'PENAWARAN_BELI'
        ORDER BY ID DESC
        ";
                              ...
                              $total_all, $sts_lunas, $memo_lunas, $akun_piutang, $kode_akun_pajak, $unit, $atas_nama, $ket_penawaran, $contact_person, $validasi_tgl, $include_ppn)
    {
        ...
        (ID_KLIEN, NO_BUKTI, ID_PELANGGAN, PELANGGAN, ALAMAT, TGL_TRX, TGL_JATUH_TEMPO, ID_PAJAK, SUB_TOTAL, NILAI_PAJAK, TOTAL, LUNAS, MEMO, KODE_AKUN_PAJAK, UNIT, TIPE ,  UP, KETERANGAN_PENAWARAN, CONTACT_PERSON, VALIDASI, INCLUDE_PPN)
        VALUES 
        ($id_klien, '$no_trx', $id_pelanggan, '$pelanggan', '$alamat_tagih', '$tgl_trx', '$tgl_jatuh_tempo', '$id_pajak', '$sub_total', '$pajak_total', '$total_all', '$sts_lunas', '$memo_lunas', '$kode_akun_pajak', '$unit', 'PENAWARAN_BELI', '$atas_nama', '$ket_penawaran', '$contact_person', '$validasi_tgl', '$include_ppn')
        ";
    ...
    function ubah_penawaran($id_penawaran, $id_klien, $no_trx, $id_pelanggan, $pelanggan, $alamat_tagih, $tgl_trx, $tgl_jatuh_tempo, $id_pajak, $sub_total, $pajak_total, $total_all, $sts_lunas, $memo_lunas, $akun_piutang, $kode_akun_pajak, $unit, $atas_nama, $ket_penawaran, $contact_person, $validasi_tgl, $include_ppn){
        ...
        UPDATE ak_pembelian SET 
            ...
            KETERANGAN_PENAWARAN = '$ket_penawaran'
