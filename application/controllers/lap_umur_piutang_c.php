...
class Lap_umur_piutang_c extends CI_Controller {
	...
	function index()
	{
		...
		$data =  array(
			'page' => "lap_umur_piutang_v", 
			'title' => "Laporan Umur Piutang", 
			'msg' => "", 
			'master' => "laporan", 
			'view' => "lap_umur_piutang_v", 
			//'dt' => $dt, 
			'msg' => $msg, 
			'user' => $user, 
			'post_url' => 'lap_umur_piutang_c/cetak_laporan', 
		);
