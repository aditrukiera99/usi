...
class Lap_komparasi_pend_biaya_c extends CI_Controller {
	...
	function __construct()
	{
	    ...
	    $this->load->model('lap_komparasi_pend_biaya_m','model');
	...
	function index()
	{
		...
		$data =  array(
			'page' => "lap_komparasi_pend_biaya_v", 
			'title' => "Laporan Komparasi Pendapatan dan Biaya", 
			'msg' => "", 
			'master' => "laporan", 
			'view' => "lap_komparasi", 
			//'dt' => $dt, 
			'msg' => $msg, 
			'user' => $user, 
			'post_url' => 'lap_komparasi_pend_biaya_c', 
		);
	...
	function cetak_penye_xls(){
		...
		$view = "xls/lap_komparasi_pend_biaya_xls";
		$dt = "";
		$judul = "";
		$dt_aktiva = "";
		$dt_wajib = "";
