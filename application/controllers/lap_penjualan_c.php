...
class Lap_penjualan_c extends CI_Controller {
	...
	function __construct()
	{
	    ...
	    $this->load->model('lap_penjualan_m','model');
	...
	function index()
	{
		...
		} else if($this->input->post('mutasi')){
			$this->cetak_mutasi();
		}
	...
	function cetak_mutasi(){
		...
		$view = "pdf/report_mutasi_barang_pdf";
		$dt = "";
		$judul = "";
