			...
			<div class="widget-container">
				<form class="form-horizontal" method="post" action="<?=base_url().$post_url;?>">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" required onkeyup="FormatCurrency(this);" class="span12" value="" name="harga_beli">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" required onkeyup="FormatCurrency(this);" class="span12" value="" name="harga_jual">
						</div>
					</div>	
