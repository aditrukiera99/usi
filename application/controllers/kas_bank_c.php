...
class Kas_bank_c extends CI_Controller {
	...
	function index()
	{
		...
		if($this->input->post('simpan')){
			...
			$saldo_awal2 = str_replace(',', '', $this->input->post('saldo_awal2'));
			...
			if($saldo_awal > 0){
				$tgl = date('d-m-Y');
				$this->model->simpan_saldo_awal($id_klien, $nomor_akun, $tgl, $saldo_awal, $saldo_awal2, $deskripsi);
				$this->model->simpan_ekuitas_saldo($id_klien, $nomor_akun, $tgl, $saldo_awal, $saldo_awal2, $deskripsi);
