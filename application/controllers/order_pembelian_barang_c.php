...
class Order_pembelian_barang_c extends CI_Controller {
	...
	function __construct()
	{
	    ...
	    $this->load->model('order_pembelian_barang_m','model');
	...
	function index()
	{
		...
		if($this->input->post('simpan')){
			...
			$this->model->simpan_order_pembelian_barang($unit, $no_opb, $tgl_trx, $uraian, $user->UNIT);
		...
		$data =  array(
			'page' => "order_pembelian_barang_v", 
			'title' => "Order Pembelian Barang",  
			'master' => "pembelian", 
			'view' => "order_pembelian_barang", 
			'dt' => $dt, 
			'msg' => $msg, 
			'tgl_full' => $tgl_full, 
			'get_list_akun_all' => $get_list_akun_all, 
			'kode_produk' => $kode_produk, 
			'post_url' => 'order_pembelian_barang_c', 
	...
	function add_new(){
		...
		$data =  array(
			'page' => "new_order_pembelian_barang_v", 
			'title' => "Buat Order Pembelian Barang", 
			'msg' => "", 
			'master' => "pembelian", 
			'view' => "order_pembelian_barang", 
			'msg' => $msg, 
	...
	function get_all_spb(){
		$sql = "
		SELECT DISTINCT a.ID, a.TGL_TRX, a.NO_BUKTI, a.MEMO FROM ak_pembelian a 
