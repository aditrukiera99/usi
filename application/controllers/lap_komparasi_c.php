...
class Lap_komparasi_c extends CI_Controller {
	...
	function __construct()
	{
	    ...
	    $this->load->model('lap_komparasi_m','model');
	...
	function index()
	{
		...
		$data =  array(
			'page' => "lap_komparasi_v", 
			'title' => "Laporan Kompilasi Laba Rugi", 
			'msg' => "", 
			'master' => "laporan", 
			'view' => "lap_komparasi", 
			//'dt' => $dt, 
