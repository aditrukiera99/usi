...
class Kwitansi_c extends CI_Controller {
	...
	function __construct()
	{
	    ...
	    $this->load->model('kwitansi_m','model');
	...
	function index()
	{
		...
		if($this->input->post('edit')){
			...
			$this->db->query("UPDATE ak_penjualan_new SET TGL_KWI = '$tgl' WHERE ID = '$id_lapor' ");
		}
	...
	function cetak($id=""){
		...
		if($dt_det->PAJAK == "PPN"){
			$this->load->view('pdf/report_kwitansi_pdf', $data);
		} else {
			$this->load->view('pdf/report_kwitansi_pdf', $data);
		}
