...
class Lap_detail_pembelian_c extends CI_Controller {
	...
	function index()
	{
		...
		$data =  array(
			...
			'msg' => $msg, 
			'user' => $user, 
			'post_url' => 'lap_detail_pembelian_c/cetak_laporan', 
		);
	...
	function cetak_laporan_pdf(){
		...
		$view = "pdf/report_detail_pembelian_pdf";
		$dt = "";
