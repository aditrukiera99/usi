...
class Lap_kas_bank_rinci_c extends CI_Controller {
	...
	function cetak_laporan_pdf(){
		...
		$view = "pdf/report_kas_bank_rinci_pdf";
		$dt = "";
		$judul = "";
