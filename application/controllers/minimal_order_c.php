...
class Minimal_order_c extends CI_Controller {
	...
	function __construct()
	{
	    ...
	    $this->load->model('minimal_order_m','model');
	}
	...
	function index()
	{
		...
		if($this->input->post('simpan')){
			...
			$this->master_model_m->simpan_log($id_user, "Menambah Minimal Order Baru di Master Minimal Order");
