...
class Input_jurnal_umum_c extends CI_Controller {
	...
	function __construct()
	{
	    ...
	    $this->load->model('input_jurnal_umum_m','model');
	...
	function index($tipe_1="", $id_bukti="")
	{
		...
		$data =  array(
			'page' => "input_jurnal_umum_v", 
			'title' => "Input Jurnal Umum",  
			'master' => "input_akuntansi", 
			'view' => "input_jurnal_umum", 
			'dt' => $dt, 
			'msg' => $msg, 
			'user' => $user, 
