...
class Lap_sisa_hutang_dagang_c extends CI_Controller {
...
>>>>>>> 172ec68308933fd1aab4f032b428947a4bd26024
			...
			'msg' => $msg, 
			'user' => $user, 
			'post_url' => 'lap_sisa_hutang_dagang_c/cetak_laporan', 
		);
	...
	function cetak_laporan_pdf(){
		...
		if($filter == "Harian"){
			$view = "pdf/lap_sisa_hutang_dagang_pdf";
			$dt = "";
