...
class Lap_pembelian_produk_supp_c extends CI_Controller {
	...
	function index()
	{
		...
		$data =  array(
			'page' => "lap_pembelian_produk_supp_v", 
			'title' => "Laporan Pembelian Produk Detail Supplier", 
			'msg' => "", 
			'master' => "laporan_pembelian", 
<<<<<<< HEAD
			'view' => "lap_pembelian_produk_supp", 
=======
			'view' => "lap_pembelian_produk_supp_v", 
>>>>>>> 172ec68308933fd1aab4f032b428947a4bd26024
			//'dt' => $dt, 
			'msg' => $msg, 
			'user' => $user, 
			'post_url' => 'lap_pembelian_produk_supp_c/cetak_laporan', 
		);
	...
	function cetak_laporan_pdf(){
		...
		if($filter == "Harian"){
			$view = "pdf/report_pembelian_produk_supp_pdf";
			$dt = "";
			...
			$view = "pdf/report_pembelian_produk_supp2_pdf";
			$dt = "";
			$dt_unit = $this->master_model_m->get_unit_by_id($unit);
