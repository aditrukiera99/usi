...
class Lap_penjualan_produk_cust_c extends CI_Controller {
	...
	function index()
	{
		...
		$data =  array(
			'page' => "lap_penjualan_produk_cust_v", 
			'title' => "Laporan Penjualan Produk Detail Per Customer", 
			'msg' => "", 
			'master' => "laporan", 
			'view' => "lap_penjualan_produk_cust_v", 
			//'dt' => $dt, 
			'msg' => $msg, 
			'user' => $user, 
			'post_url' => 'lap_penjualan_produk_cust_c/cetak_laporan', 
		);
