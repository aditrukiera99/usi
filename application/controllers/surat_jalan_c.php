...
class Surat_jalan_c extends CI_Controller {
	...
	function __construct()
	{
	    ...
	    $this->load->model('surat_jalan_m','model');
	...
	function index()
	{
		...
		if($this->input->post('edit')){
			...
			$this->db->query("UPDATE ak_penjualan_new SET TGL_SJ = '$tgl' WHERE ID = '$id_lapor' ");
		}
	...
	function cetak($id=""){
		...
		$this->load->view('pdf/report_surat_jalan_solar_pdf', $data);
	}
