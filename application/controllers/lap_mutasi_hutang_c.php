...
class Lap_mutasi_hutang_c extends CI_Controller {
	...
	function __construct()
	{
	    ...
	    $this->load->model('lap_mutasi_hutang_m','model');
	...
	function index()
	{
		...
		$data =  array(
			'page' => "lap_mutasi_hutang_v", 
			'title' => "Laporan Mutasi Hutang", 
			'msg' => "", 
			'master' => "laporan", 
			'view' => "mutasi_hutang", 
			//'dt' => $dt, 
	...
	function cetak_penye_xls(){
		...
		$view = "xls/report_mutasi_hutang_xls";
		$dt = "";
		$judul = "";
		$dt_aktiva = "";
		$dt_wajib = "";
	...
	function cetak_penye_pdf(){
		...
		$filter = $this->input->post('filter');
		$unit = $this->input->post('unit');
		$view = "pdf/report_mutasi_hutang_pdf";
		$dt = "";
		$judul = "";
		$dt_aktiva = "";
		$dt_wajib = "";
