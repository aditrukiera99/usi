...
class Set_tanggal_giro_c extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('set_tanggal_giro_m','model');
	...
	public function index()
	{
		...
		$data = array(
				'title' 	 		=> 'SET TANGGAL CAIR GIRO',
				'page'  	 		=> 'set_tanggal_giro_v',
				'sub_menu' 	 		=> 'Flow Sistem',
				'sub_menu1'	 		=> 'Set Tanggal Cair Giro',
				'menu' 	   	 		=> 'flow_sistem',
				'menu2'		 		=> 'set_tanggal_giro',
				'lihat_data' 		=> $this->model->lihat_data(),
				'url_simpan' 		=> base_url().'set_tanggal_giro_c',
				'url_hapus'  		=> base_url().'set_tanggal_giro_c/hapus',
				'url_ubah'	 		=> base_url().'set_tanggal_giro_c',
				'get_nomor'	 		=> $get_nomor,
			);
