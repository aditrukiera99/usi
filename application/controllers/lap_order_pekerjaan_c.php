...
class lap_order_pekerjaan_c extends CI_Controller {
	...
	{
		$data = array(
				'title' 	 		=> 'Laporan Order Pekerjaan',
				'page'  	 		=> 'lap_order_pekerjaan_v',
				'sub_menu' 	 		=> 'Laporan',
	...
	function cetak($id=""){
		...
		$view = "pdf/lap_order_pekerjaan_pdf";
        ...
        $dt = $this->db->query("SELECT tb.* , ms.nama_divisi FROM tb_order_pekerjaan tb, master_divisi ms WHERE tb.divisi = ms.id_divisi AND tb.tanggal LIKE '%-$bulan-$tahun%' ")->result();
