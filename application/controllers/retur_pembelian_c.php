...
class Retur_pembelian_c extends CI_Controller {
	...
	function __construct()
	{
	    ...
	    $this->load->model('retur_pembelian_m','model');
	...
	function add_new(){
		...
		$data =  array(
			'page' => "new_retur_pembelian_v", 
			'title' => "Buat Retur Pembelian Barang", 
			'msg' => "", 
			'master' => "pembelian", 
			'view' => "retur_pembelian", 
			'msg' => $msg, 
	...
	function cetak($id=""){
		...
		$this->load->view('pdf/report_surat_retur_pembelian_pdf', $data);
	}
