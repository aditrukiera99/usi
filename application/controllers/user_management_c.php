...
class User_management_c extends CI_Controller {
	...
	function __construct()
	{
	    ...
	    $this->load->model('user_management_m','model');
	    error_reporting(0);
	}
	...
	function add_new_user(){
		...
		if($this->input->post('simpan')){
		    ...
		    if($cek_username > 0){
		    	...
		    	if($password != $password2){
		    		...
		    		$this->db->query("INSERT INTO ak_user (ID_KLIEN, USERNAME, PASSWORD, NAMA, LEVEL, UNIT, APPROVE) VALUES (13, '$username', '$pass', '$nama_lengkap', 'USER', '$user->UNIT', 3)");
		    	}
		    }
		}
		...
		$data =  array(
			...
			'master' => "setting", 
			'view' => "user_management", 
			'post_url' => 'user_management_c/add_new_user', 
		);
