...
class lap_jasa_indent_c extends CI_Controller {
	...
	{
		$data = array(
				'title' 	 		=> 'Laporan Jasa Indent',
				'page'  	 		=> 'lap_jasa_indent_v',
				'sub_menu' 	 		=> 'Laporan',
	...
	function cetak($id=""){
        ...
        $dt = $this->db->query("SELECT tb.* , ms.nama_supplier FROM tb_pembelian_jasa tb, master_supplier ms WHERE tb.kode_supplier = ms.id_supplier AND tb.tanggal LIKE '%-$bulan-$tahun%' ")->result();
