...
class Lap_penerimaan_barang_c extends CI_Controller {
	...
	function __construct()
	{
	    ...
	    $this->load->model('lap_penerimaan_barang_m','model');
	...
	function index()
	{
		...
		if($this->input->post('simpan')){
			...
			$this->model->simpan_order_pembelian_barang($unit, $no_opb, $tgl_trx, $uraian, $user->UNIT, $id_pelanggan, $pelanggan, $no_po);
		...
		$data =  array(
			'page' => "lap_penerimaan_barang_v", 
			'title' => "Laporan Penerimaan Barang",  
			'master' => "pembelian", 
			'view' => "lap_penerimaan_barang", 
			'dt' => $dt, 
			'msg' => $msg, 
			'tgl_full' => $tgl_full, 
			'get_list_akun_all' => $get_list_akun_all, 
			'kode_produk' => $kode_produk, 
			'post_url' => 'lap_penerimaan_barang_c', 
