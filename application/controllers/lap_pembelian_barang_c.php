...
class lap_pembelian_barang_c extends CI_Controller {
	...
	function cetak($id=""){
		...
		$view = "pdf/lap_pembelian_barang_pdf";
        ...
        $dt = $this->db->query("SELECT * FROM tb_purchase_order WHERE tanggal LIKE '%-$bulan-$tahun%' ")->result();
