...
class Penawaran_barang_beli_c extends CI_Controller {
	...
	function __construct()
	{
	    ...
	    $this->load->model('penawaran_barang_beli_m','model');
	...
	function new_input(){
		...
		$data =  array(
			'page' => "buat_penawaran_barang_beli_v", 
	...
	function ubah_data($id=""){
		...
		$dt_detail = $this->model->get_data_trx_detail_ubah($id);

		$data =  array(
			'page' => "edit_penawaran_barang_beli_v", 
	...
	function cetak($id=""){
		...
		$this->load->view('pdf/report_penawaran_beli_pdf.php', $data);
	}
