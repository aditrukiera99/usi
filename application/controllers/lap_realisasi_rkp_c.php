...
class Lap_realisasi_rkp_c extends CI_Controller {
	...
	function __construct()
	{
	    ...
	    $this->load->model('lap_realisasi_rkp_m','model');
	...
	function index()
	{
		...
		$data =  array(
			'page' => "lap_realisasi_rkp_v", 
			'title' => "Laporan Realisasi Pelaksanaan RKP", 
			'msg' => "", 
			'master' => "laporan", 
			'view' => "lap_realisasi_rkp", 
			//'dt' => $dt, 
			'msg' => $msg, 
			'user' => $user, 
			'post_url' => 'lap_realisasi_rkp_c', 
		);
	...
	function cetak_penye_pdf(){
		...
		$view = "pdf/report_realisasi_pelaksanaan_rkp_pdf";
		$dt = "";
		$judul = "";
		$dt_aktiva = "";
		$dt_wajib = "";
	...
	function cetak_penye_xls(){
		...
		$filter = $this->input->post('filter');
		$unit = $this->input->post('unit');
		$view = "xls/report_realisasi_pelaksanaan_rkp_xls";
		$dt = "";
		$judul = "";
		$dt_aktiva = "";
		$dt_wajib = "";
