...
class Lap_hasil_pendapatan_c extends CI_Controller {
	...
	function __construct()
	{
	    ...
	    $this->load->model('lap_hasil_pendapatan_m','model');
	...
	function index()
	{
		...
		$data =  array(
			'page' => "lap_hasil_pendapatan_v", 
			'title' => "Laporan Hasil Pendapatan", 
			'msg' => "", 
			'master' => "laporan", 
			'view' => "lap_pendapatan", 
			//'dt' => $dt, 
			'msg' => $msg, 
			'user' => $user, 
			'post_url' => 'lap_hasil_pendapatan_c', 
		);
	...
	function cetak_penye_xls(){
		...
		$view = "xls/lap_hasil_pendapatan_xls";
		$dt = "";
		$judul = "";
		$dt_aktiva = "";
		$dt_wajib = "";
	...
	function cetak_penye_pdf(){
		...
		$filter = $this->input->post('filter');
		$unit = $this->input->post('unit');
		$view = "pdf/lap_hasil_pendapatan_pdf";
		$dt = "";
		$judul = "";
		$dt_aktiva = "";
		$dt_wajib = "";
