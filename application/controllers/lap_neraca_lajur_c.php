...
class Lap_neraca_lajur_c extends CI_Controller {
	...
	function __construct()
	{
	    ...
	    $this->load->model('lap_neraca_lajur_m','model');
	...
	function index()
	{
		...
		$data =  array(
			'page' => "lap_neraca_lajur_v", 
			'title' => "Laporan Neraca Lajur Perusahaan", 
			'msg' => "", 
			'master' => "laporan", 
			'view' => "neraca_lajur", 
			//'dt' => $dt, 
	...
	function cetak_penye_pdf(){
		...
		$view = "pdf/report_laporan_neraca_lajur_pdf";
		$dt = "";
		$judul = "";
		$dt_aktiva = "";
		$dt_wajib = "";
	...
	function cetak_penye_xls(){
		...
		$filter = $this->input->post('filter');
		$unit = $this->input->post('unit');
		$view = "xls/report_laporan_neraca_lajur_xls";
		$dt = "";
		$judul = "";
		$dt_aktiva = "";
		$dt_wajib = "";
